...
printint(int fd, int xx, int base, int sgn)
{
 ...
 31c:	8a 92 e8 06 00 00    	mov    0x6e8(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 3d4:	ff 24 85 90 06 00 00 	jmp    *0x690(,%eax,4)
 3db:	90                   	nop
        state = '%';
 ...
 4b9:	8d 76 00             	lea    0x0(%esi),%esi
          s = "(null)";
 4bc:	ba 87 06 00 00       	mov    $0x687,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 4e0:	a1 fc 06 00 00       	mov    0x6fc,%eax
 ...
 50f:	89 0a                	mov    %ecx,(%edx)
    ...
    p->s.ptr = bp;
  freep = p;
 511:	89 15 fc 06 00 00    	mov    %edx,0x6fc
}
 517:	5b                   	pop    %ebx
 518:	5e                   	pop    %esi
 519:	5f                   	pop    %edi
 ...
 54e:	89 0a                	mov    %ecx,(%edx)
  freep = p;
 550:	89 15 fc 06 00 00    	mov    %edx,0x6fc
}
 556:	5b                   	pop    %ebx
 557:	5e                   	pop    %esi
 558:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 56e:	46                   	inc    %esi
  if((prevp = freep) == 0){
 56f:	8b 3d fc 06 00 00    	mov    0x6fc,%edi
 ...
 5a7:	73 4b                	jae    5f4 <malloc+0x98>
    ...
    if(p == freep)
 5a9:	8b 3d fc 06 00 00    	mov    0x6fc,%edi
 ...
 5d2:	e8 fd fe ff ff       	call   4d4 <free>
  return freep;
 5d7:	8b 15 fc 06 00 00    	mov    0x6fc,%edx
 ...
 600:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 603:	89 15 fc 06 00 00    	mov    %edx,0x6fc
      return (void*)(p + 1);
 ...
 61e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 620:	c7 05 fc 06 00 00 00 	movl   $0x700,0x6fc
 627:	07 00 00 
 62a:	c7 05 00 07 00 00 00 	movl   $0x700,0x700
 631:	07 00 00 
    base.s.size = 0;
 634:	c7 05 04 07 00 00 00 	movl   $0x0,0x704
 63b:	00 00 00 
 63e:	bf 00 07 00 00       	mov    $0x700,%edi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
