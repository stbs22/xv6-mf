...
801056b3:	83 ec 08             	sub    $0x8,%esp
  exit();
801056b6:	e8 d5 e6 ff ff       	call   80103d90 <exit>
...
{
  return wait();
801056c0:	e9 fb e7 ff ff       	jmp    80103ec0 <wait>
...
801056dc:	e8 3f f2 ff ff       	call   80104920 <argint>
...
801056ee:	e8 6d ea ff ff       	call   80104160 <kill>
...
8010572d:	e8 ee f1 ff ff       	call   80104920 <argint>
...
8010577d:	e8 9e f1 ff ff       	call   80104920 <argint>
...
80105795:	e8 06 ee ff ff       	call   801045a0 <acquire>
  ticks0 = ticks;
...
801057bd:	e8 7e e8 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
