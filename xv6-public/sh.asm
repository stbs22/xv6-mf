...
fork1(void)
{
  ...
  if(buf[0] == 0) // EOF
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      fc:	68 75 11 00 00       	push   $0x1175
     101:	6a 02                	push   $0x2
     103:	e8 e0 0c 00 00       	call   de8 <printf>
...
000001a0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    panic("runcmd");
     ...
     295:	68 d4 10 00 00       	push   $0x10d4
     29a:	e8 c5 fe ff ff       	call   164 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     29f:	51                   	push   %ecx
     2a0:	ff 73 08             	push   0x8(%ebx)
     2a3:	68 eb 10 00 00       	push   $0x10eb
     2a8:	6a 02                	push   $0x2
     2aa:	e8 39 0b 00 00       	call   de8 <printf>
      exit();
     2af:	e8 0b 0a 00 00       	call   cbf <exit>
      panic("pipe");
     2b4:	83 ec 0c             	sub    $0xc,%esp
     2b7:	68 fb 10 00 00       	push   $0x10fb
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     327:	6a 54                	push   $0x54
     329:	e8 a6 0c 00 00       	call   fd4 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     353:	6a 18                	push   $0x18
     355:	e8 7a 0c 00 00       	call   fd4 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     39b:	6a 0c                	push   $0xc
     39d:	e8 32 0c 00 00       	call   fd4 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3d3:	6a 0c                	push   $0xc
     3d5:	e8 fa 0b 00 00       	call   fd4 <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     40b:	6a 08                	push   $0x8
     40d:	e8 c2 0b 00 00       	call   fd4 <malloc>
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4e6:	50                   	push   %eax
     4e7:	68 28 12 00 00       	push   $0x1228
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     503:	50                   	push   %eax
     504:	68 30 12 00 00       	push   $0x1230
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     58f:	50                   	push   %eax
     590:	68 30 12 00 00       	push   $0x1230
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     5e3:	90                   	nop
     5e4:	50                   	push   %eax
     5e5:	68 1d 11 00 00       	push   $0x111d
     5ea:	53                   	push   %ebx
     5eb:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     642:	6a 18                	push   $0x18
     644:	e8 8b 09 00 00       	call   fd4 <malloc>
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     69b:	6a 18                	push   $0x18
     69d:	e8 32 09 00 00       	call   fd4 <malloc>
  ...
  return cmd;
     ...
     6f2:	68 00 11 00 00       	push   $0x1100
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     70b:	68 20 11 00 00       	push   $0x1120
     710:	57                   	push   %edi
     711:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     727:	6a 54                	push   $0x54
     729:	e8 a6 08 00 00       	call   fd4 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(!peek(ps, es, "|)&;")){
     76d:	50                   	push   %eax
     76e:	68 37 11 00 00       	push   $0x1137
     773:	57                   	push   %edi
     774:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     7b6:	68 29 11 00 00       	push   $0x1129
  ...
  cmd->eargv[argc] = 0;
     ...
     7f5:	68 22 11 00 00       	push   $0x1122
...
00000800 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     81b:	68 3c 11 00 00       	push   $0x113c
     820:	57                   	push   %edi
     821:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     855:	e8 7a 07 00 00       	call   fd4 <malloc>
...
00000884 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     8b6:	e8 19 07 00 00       	call   fd4 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(peek(ps, es, "&")){
     8dc:	50                   	push   %eax
     8dd:	68 3e 11 00 00       	push   $0x113e
     8e2:	57                   	push   %edi
     8e3:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     8f0:	51                   	push   %ecx
     8f1:	68 3a 11 00 00       	push   $0x113a
     8f6:	57                   	push   %edi
     8f7:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     92d:	e8 a2 06 00 00       	call   fd4 <malloc>
...
0000095c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     96b:	68 20 11 00 00       	push   $0x1120
     970:	56                   	push   %esi
     971:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     997:	68 5c 11 00 00       	push   $0x115c
     99c:	56                   	push   %esi
     99d:	53                   	push   %ebx
...
00000a80 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     aa5:	68 ea 10 00 00       	push   $0x10ea
     aaa:	53                   	push   %ebx
     aab:	57                   	push   %edi
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     ace:	52                   	push   %edx
     acf:	50                   	push   %eax
     ad0:	68 5e 11 00 00       	push   $0x115e
     ad5:	6a 02                	push   $0x2
     ad7:	e8 0c 03 00 00       	call   de8 <printf>
    panic("syntax");
     adc:	c7 04 24 22 11 00 00 	movl   $0x1122,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
     ...
     d69:	89 45 bc             	mov    %eax,-0x44(%ebp)
     d6c:	89 4d c4             	mov    %ecx,-0x3c(%ebp)
  uint x;
  ...
  if(sgn && xx < 0){
    neg = 1;
    x = -xx;
     d6f:	89 d1                	mov    %edx,%ecx
  if(sgn && xx < 0){
     d71:	8b 5d 08             	mov    0x8(%ebp),%ebx
     d74:	85 db                	test   %ebx,%ebx
     d76:	74 04                	je     d7c <printint+0x1c>
     d78:	85 d2                	test   %edx,%edx
     d7a:	78 68                	js     de4 <printint+0x84>
  neg = 0;
     d7c:	c7 45 08 00 00 00 00 	movl   $0x0,0x8(%ebp)
  } else {
    x = xx;
  }
  ...
  i = 0;
     ...
     d85:	8d 75 d7             	lea    -0x29(%ebp),%esi
  do{
    buf[i++] = digits[x % base];
     d88:	89 c8                	mov    %ecx,%eax
     d8a:	31 d2                	xor    %edx,%edx
     d8c:	f7 75 c4             	divl   -0x3c(%ebp)
     d8f:	89 fb                	mov    %edi,%ebx
     d91:	8d 7f 01             	lea    0x1(%edi),%edi
     d94:	8a 92 14 12 00 00    	mov    0x1214(%edx),%dl
     d9a:	88 54 1e 01          	mov    %dl,0x1(%esi,%ebx,1)
  }while((x /= base) != 0);
     d9e:	89 4d c0             	mov    %ecx,-0x40(%ebp)
     da1:	89 c1                	mov    %eax,%ecx
     da3:	8b 45 c4             	mov    -0x3c(%ebp),%eax
     da6:	3b 45 c0             	cmp    -0x40(%ebp),%eax
     da9:	76 dd                	jbe    d88 <printint+0x28>
  if(neg)
     dab:	8b 4d 08             	mov    0x8(%ebp),%ecx
     dae:	85 c9                	test   %ecx,%ecx
     db0:	74 09                	je     dbb <printint+0x5b>
    buf[i++] = '-';
     db2:	c6 44 3d d8 2d       	movb   $0x2d,-0x28(%ebp,%edi,1)
    buf[i++] = digits[x % base];
     db7:	89 fb                	mov    %edi,%ebx
    buf[i++] = '-';
     db9:	b2 2d                	mov    $0x2d,%dl

  while(--i >= 0)
     dbb:	8d 5c 1d d7          	lea    -0x29(%ebp,%ebx,1),%ebx
     dbf:	8b 7d bc             	mov    -0x44(%ebp),%edi
     dc2:	eb 03                	jmp    dc7 <printint+0x67>
    putc(fd, buf[i]);
     dc4:	8a 13                	mov    (%ebx),%dl
     dc6:	4b                   	dec    %ebx
     dc7:	88 55 d7             	mov    %dl,-0x29(%ebp)
  write(fd, &c, 1);
     dca:	50                   	push   %eax
     dcb:	6a 01                	push   $0x1
     dcd:	56                   	push   %esi
     dce:	57                   	push   %edi
     dcf:	e8 0b ff ff ff       	call   cdf <write>
  while(--i >= 0)
     dd4:	83 c4 10             	add    $0x10,%esp
     dd7:	39 de                	cmp    %ebx,%esi
     dd9:	75 e9                	jne    dc4 <printint+0x64>
}
    ...
    x = -xx;
     de4:	f7 d9                	neg    %ecx
     de6:	eb 9b                	jmp    d83 <printint+0x23>
...
printf(int fd, const char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     dfb:	74 64                	je     e61 <printf+0x79>
     dfd:	43                   	inc    %ebx
  ap = (uint*)(void*)&fmt + 1;
     dfe:	8d 45 10             	lea    0x10(%ebp),%eax
     e01:	89 45 d0             	mov    %eax,-0x30(%ebp)
  state = 0;
     e04:	31 c9                	xor    %ecx,%ecx
  write(fd, &c, 1);
     e06:	8d 7d e7             	lea    -0x19(%ebp),%edi
     e09:	eb 24                	jmp    e2f <printf+0x47>
     e0b:	90                   	nop
     e0c:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
     e0f:	83 f8 25             	cmp    $0x25,%eax
     e12:	74 40                	je     e54 <printf+0x6c>
        state = '%';
      } else {
        putc(fd, c);
     e14:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
     e17:	50                   	push   %eax
     e18:	6a 01                	push   $0x1
     e1a:	57                   	push   %edi
     e1b:	56                   	push   %esi
     e1c:	e8 be fe ff ff       	call   cdf <write>
        putc(fd, c);
     e21:	83 c4 10             	add    $0x10,%esp
     e24:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
  for(i = 0; fmt[i]; i++){
     e27:	43                   	inc    %ebx
     e28:	8a 53 ff             	mov    -0x1(%ebx),%dl
     e2b:	84 d2                	test   %dl,%dl
     e2d:	74 32                	je     e61 <printf+0x79>
    c = fmt[i] & 0xff;
     e2f:	0f b6 c2             	movzbl %dl,%eax
    if(state == 0){
     e32:	85 c9                	test   %ecx,%ecx
     e34:	74 d6                	je     e0c <printf+0x24>
      }
    } else if(state == '%'){
     e36:	83 f9 25             	cmp    $0x25,%ecx
     e39:	75 ec                	jne    e27 <printf+0x3f>
      if(c == 'd'){
     e3b:	83 f8 25             	cmp    $0x25,%eax
     e3e:	0f 84 e4 00 00 00    	je     f28 <printf+0x140>
     e44:	83 e8 63             	sub    $0x63,%eax
     e47:	83 f8 15             	cmp    $0x15,%eax
     e4a:	77 20                	ja     e6c <printf+0x84>
     e4c:	ff 24 85 bc 11 00 00 	jmp    *0x11bc(,%eax,4)
     e53:	90                   	nop
        state = '%';
     e54:	b9 25 00 00 00       	mov    $0x25,%ecx
  for(i = 0; fmt[i]; i++){
     e59:	43                   	inc    %ebx
     e5a:	8a 53 ff             	mov    -0x1(%ebx),%dl
     e5d:	84 d2                	test   %dl,%dl
     e5f:	75 ce                	jne    e2f <printf+0x47>
        putc(fd, c);
      }
      state = 0;
    }
     ...
     e61:	8d 65 f4             	lea    -0xc(%ebp),%esp
     e64:	5b                   	pop    %ebx
     e65:	5e                   	pop    %esi
     e66:	5f                   	pop    %edi
     e67:	5d                   	pop    %ebp
     e68:	c3                   	ret    
     e69:	8d 76 00             	lea    0x0(%esi),%esi
     e6c:	88 55 d4             	mov    %dl,-0x2c(%ebp)
        putc(fd, '%');
     e6f:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
  write(fd, &c, 1);
     e73:	50                   	push   %eax
     e74:	6a 01                	push   $0x1
     e76:	57                   	push   %edi
     e77:	56                   	push   %esi
     e78:	e8 62 fe ff ff       	call   cdf <write>
        putc(fd, c);
     e7d:	8a 55 d4             	mov    -0x2c(%ebp),%dl
     e80:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
     e83:	83 c4 0c             	add    $0xc,%esp
     e86:	6a 01                	push   $0x1
     e88:	57                   	push   %edi
     e89:	56                   	push   %esi
     e8a:	e8 50 fe ff ff       	call   cdf <write>
        putc(fd, c);
     e8f:	83 c4 10             	add    $0x10,%esp
      state = 0;
     e92:	31 c9                	xor    %ecx,%ecx
     e94:	eb 91                	jmp    e27 <printf+0x3f>
     e96:	66 90                	xchg   %ax,%ax
        printint(fd, *ap, 16, 0);
     e98:	83 ec 0c             	sub    $0xc,%esp
     e9b:	6a 00                	push   $0x0
     e9d:	b9 10 00 00 00       	mov    $0x10,%ecx
     ea2:	8b 45 d0             	mov    -0x30(%ebp),%eax
     ea5:	8b 10                	mov    (%eax),%edx
     ea7:	89 f0                	mov    %esi,%eax
     ea9:	e8 b2 fe ff ff       	call   d60 <printint>
        ap++;
     eae:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
     eb2:	83 c4 10             	add    $0x10,%esp
      state = 0;
     eb5:	31 c9                	xor    %ecx,%ecx
        ap++;
     eb7:	e9 6b ff ff ff       	jmp    e27 <printf+0x3f>
        s = (char*)*ap;
     ebc:	8b 45 d0             	mov    -0x30(%ebp),%eax
     ebf:	8b 10                	mov    (%eax),%edx
        ap++;
     ec1:	83 c0 04             	add    $0x4,%eax
     ec4:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
     ec7:	85 d2                	test   %edx,%edx
     ec9:	74 69                	je     f34 <printf+0x14c>
        while(*s != 0){
     ecb:	8a 02                	mov    (%edx),%al
     ecd:	84 c0                	test   %al,%al
     ecf:	74 71                	je     f42 <printf+0x15a>
     ed1:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
     ed4:	89 d3                	mov    %edx,%ebx
  ...
  write(fd, &c, 1);
     ...
     ede:	57                   	push   %edi
     edf:	56                   	push   %esi
     ee0:	e8 fa fd ff ff       	call   cdf <write>
          s++;
     ee5:	43                   	inc    %ebx
        while(*s != 0){
     ...
     eed:	75 e9                	jne    ed8 <printf+0xf0>
      state = 0;
     eef:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
     ef2:	31 c9                	xor    %ecx,%ecx
     ef4:	e9 2e ff ff ff       	jmp    e27 <printf+0x3f>
     ef9:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 10, 1);
     efc:	83 ec 0c             	sub    $0xc,%esp
     eff:	6a 01                	push   $0x1
     f01:	b9 0a 00 00 00       	mov    $0xa,%ecx
     f06:	eb 9a                	jmp    ea2 <printf+0xba>
        putc(fd, *ap);
     f08:	8b 45 d0             	mov    -0x30(%ebp),%eax
     f0b:	8b 00                	mov    (%eax),%eax
     f0d:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
     f10:	51                   	push   %ecx
     f11:	6a 01                	push   $0x1
     f13:	57                   	push   %edi
     f14:	56                   	push   %esi
     f15:	e8 c5 fd ff ff       	call   cdf <write>
        ap++;
     f1a:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
     f1e:	83 c4 10             	add    $0x10,%esp
      state = 0;
     f21:	31 c9                	xor    %ecx,%ecx
     f23:	e9 ff fe ff ff       	jmp    e27 <printf+0x3f>
        putc(fd, c);
     f28:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
     f2b:	52                   	push   %edx
     f2c:	e9 55 ff ff ff       	jmp    e86 <printf+0x9e>
     f31:	8d 76 00             	lea    0x0(%esi),%esi
          s = "(null)";
     f34:	ba b4 11 00 00       	mov    $0x11b4,%edx
        while(*s != 0){
     f39:	b0 28                	mov    $0x28,%al
     f3b:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
     f3e:	89 d3                	mov    %edx,%ebx
     f40:	eb 96                	jmp    ed8 <printf+0xf0>
      state = 0;
     f42:	31 c9                	xor    %ecx,%ecx
     f44:	e9 de fe ff ff       	jmp    e27 <printf+0x3f>
...
free(void *ap)
{
     ...
     f50:	56                   	push   %esi
     f51:	53                   	push   %ebx
     f52:	8b 5d 08             	mov    0x8(%ebp),%ebx
  Header *bp, *p;

  bp = (Header*)ap - 1;
     f55:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     f58:	a1 a4 12 00 00       	mov    0x12a4,%eax
     f5d:	8d 76 00             	lea    0x0(%esi),%esi
     f60:	89 c2                	mov    %eax,%edx
     f62:	8b 00                	mov    (%eax),%eax
     f64:	39 ca                	cmp    %ecx,%edx
     f66:	73 2c                	jae    f94 <free+0x48>
     f68:	39 c1                	cmp    %eax,%ecx
     f6a:	72 04                	jb     f70 <free+0x24>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
     f6c:	39 c2                	cmp    %eax,%edx
     f6e:	72 f0                	jb     f60 <free+0x14>
      break;
  if(bp + bp->s.size == p->s.ptr){
     f70:	8b 73 fc             	mov    -0x4(%ebx),%esi
     f73:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
     f76:	39 f8                	cmp    %edi,%eax
     f78:	74 2c                	je     fa6 <free+0x5a>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
     f7a:	89 43 f8             	mov    %eax,-0x8(%ebx)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
     f7d:	8b 42 04             	mov    0x4(%edx),%eax
     f80:	8d 34 c2             	lea    (%edx,%eax,8),%esi
     f83:	39 f1                	cmp    %esi,%ecx
     f85:	74 36                	je     fbd <free+0x71>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
     f87:	89 0a                	mov    %ecx,(%edx)
  } else
    p->s.ptr = bp;
  freep = p;
     f89:	89 15 a4 12 00 00    	mov    %edx,0x12a4
}
     f8f:	5b                   	pop    %ebx
     f90:	5e                   	pop    %esi
     f91:	5f                   	pop    %edi
     ...
     f93:	c3                   	ret    
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
     f94:	39 c2                	cmp    %eax,%edx
     f96:	72 c8                	jb     f60 <free+0x14>
     f98:	39 c1                	cmp    %eax,%ecx
     f9a:	73 c4                	jae    f60 <free+0x14>
  if(bp + bp->s.size == p->s.ptr){
     f9c:	8b 73 fc             	mov    -0x4(%ebx),%esi
     f9f:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
     fa2:	39 f8                	cmp    %edi,%eax
     fa4:	75 d4                	jne    f7a <free+0x2e>
    bp->s.size += p->s.ptr->s.size;
     fa6:	03 70 04             	add    0x4(%eax),%esi
     fa9:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
     fac:	8b 02                	mov    (%edx),%eax
     fae:	8b 00                	mov    (%eax),%eax
     fb0:	89 43 f8             	mov    %eax,-0x8(%ebx)
  if(p + p->s.size == bp){
     fb3:	8b 42 04             	mov    0x4(%edx),%eax
     fb6:	8d 34 c2             	lea    (%edx,%eax,8),%esi
     fb9:	39 f1                	cmp    %esi,%ecx
     fbb:	75 ca                	jne    f87 <free+0x3b>
    p->s.size += bp->s.size;
     fbd:	03 43 fc             	add    -0x4(%ebx),%eax
     fc0:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
     fc3:	8b 4b f8             	mov    -0x8(%ebx),%ecx
     fc6:	89 0a                	mov    %ecx,(%edx)
  freep = p;
     fc8:	89 15 a4 12 00 00    	mov    %edx,0x12a4
}
     fce:	5b                   	pop    %ebx
     fcf:	5e                   	pop    %esi
     fd0:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
     ...
     fd8:	56                   	push   %esi
     fd9:	53                   	push   %ebx
     fda:	83 ec 1c             	sub    $0x1c,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
     fdd:	8b 45 08             	mov    0x8(%ebp),%eax
     fe0:	8d 70 07             	lea    0x7(%eax),%esi
     fe3:	c1 ee 03             	shr    $0x3,%esi
     fe6:	46                   	inc    %esi
  if((prevp = freep) == 0){
     fe7:	8b 3d a4 12 00 00    	mov    0x12a4,%edi
     fed:	85 ff                	test   %edi,%edi
     fef:	0f 84 a3 00 00 00    	je     1098 <malloc+0xc4>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
     ff5:	8b 17                	mov    (%edi),%edx
    if(p->s.size >= nunits){
     ff7:	8b 4a 04             	mov    0x4(%edx),%ecx
     ffa:	39 f1                	cmp    %esi,%ecx
     ffc:	73 68                	jae    1066 <malloc+0x92>
     ffe:	89 f3                	mov    %esi,%ebx
    1000:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
    1006:	0f 82 80 00 00 00    	jb     108c <malloc+0xb8>
  p = sbrk(nu * sizeof(Header));
    100c:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    1013:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    1016:	eb 11                	jmp    1029 <malloc+0x55>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1018:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    101a:	8b 48 04             	mov    0x4(%eax),%ecx
    101d:	39 f1                	cmp    %esi,%ecx
    101f:	73 4b                	jae    106c <malloc+0x98>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    1021:	8b 3d a4 12 00 00    	mov    0x12a4,%edi
    1027:	89 c2                	mov    %eax,%edx
    1029:	39 d7                	cmp    %edx,%edi
    102b:	75 eb                	jne    1018 <malloc+0x44>
  p = sbrk(nu * sizeof(Header));
    102d:	83 ec 0c             	sub    $0xc,%esp
    1030:	ff 75 e4             	push   -0x1c(%ebp)
    1033:	e8 0f fd ff ff       	call   d47 <sbrk>
  if(p == (char*)-1)
    1038:	83 c4 10             	add    $0x10,%esp
    103b:	83 f8 ff             	cmp    $0xffffffff,%eax
    103e:	74 1c                	je     105c <malloc+0x88>
  hp->s.size = nu;
    1040:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    1043:	83 ec 0c             	sub    $0xc,%esp
    1046:	83 c0 08             	add    $0x8,%eax
    1049:	50                   	push   %eax
    104a:	e8 fd fe ff ff       	call   f4c <free>
  return freep;
    104f:	8b 15 a4 12 00 00    	mov    0x12a4,%edx
      if((p = morecore(nunits)) == 0)
    1055:	83 c4 10             	add    $0x10,%esp
    1058:	85 d2                	test   %edx,%edx
    105a:	75 bc                	jne    1018 <malloc+0x44>
        return 0;
    ...
    1068:	89 fa                	mov    %edi,%edx
    106a:	66 90                	xchg   %ax,%ax
      if(p->s.size == nunits)
    106c:	39 ce                	cmp    %ecx,%esi
    106e:	74 54                	je     10c4 <malloc+0xf0>
        p->s.size -= nunits;
    1070:	29 f1                	sub    %esi,%ecx
    1072:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    1075:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    1078:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    ...
    1091:	e9 76 ff ff ff       	jmp    100c <malloc+0x38>
    1096:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
    1098:	c7 05 a4 12 00 00 a8 	movl   $0x12a8,0x12a4
    109f:	12 00 00 
    10a2:	c7 05 a8 12 00 00 a8 	movl   $0x12a8,0x12a8
    10a9:	12 00 00 
    base.s.size = 0;
    10ac:	c7 05 ac 12 00 00 00 	movl   $0x0,0x12ac
    10b3:	00 00 00 
    10b6:	bf a8 12 00 00       	mov    $0x12a8,%edi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    10bb:	89 fa                	mov    %edi,%edx
    10bd:	e9 3c ff ff ff       	jmp    ffe <malloc+0x2a>
    10c2:	66 90                	xchg   %ax,%ax
        prevp->s.ptr = p->s.ptr;
    10c4:	8b 08                	mov    (%eax),%ecx
    10c6:	89 0a                	mov    %ecx,(%edx)
    10c8:	eb b1                	jmp    107b <malloc+0xa7>
