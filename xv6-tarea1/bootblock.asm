...
readseg(uchar* pa, uint count, uint offset)
{
  ...
  for(; pa < epa; pa += SECTSIZE, offset++)
    ...
    7d11:	76 18                	jbe    7d2b <readseg+0x3d>
    readsect(pa, offset);
  ...
  for(; pa < epa; pa += SECTSIZE, offset++)
    ...
    7d29:	77 e8                	ja     7d13 <readseg+0x25>
}
...
00007d33 <bootmain>:
{
  ...
  for(; ph < eph; ph++){
    ...
    7d8e:	39 de                	cmp    %ebx,%esi
    7d90:	76 eb                	jbe    7d7d <bootmain+0x4a>
    pa = (uchar*)ph->paddr;
    ...
    7dad:	39 c1                	cmp    %eax,%ecx
    7daf:	76 da                	jbe    7d8b <bootmain+0x58>
