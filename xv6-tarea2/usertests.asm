...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
      11:	68 72 49 00 00       	push   $0x4972
      16:	6a 01                	push   $0x1
      18:	e8 83 36 00 00       	call   36a0 <printf>

  if(open("usertests.ran", 0) >= 0){
      1d:	59                   	pop    %ecx
      1e:	58                   	pop    %eax
      1f:	6a 00                	push   $0x0
      21:	68 86 49 00 00       	push   $0x4986
    ...
    printf(1, "already ran user tests -- rebuild fs.img\n");
      32:	52                   	push   %edx
      33:	52                   	push   %edx
      34:	68 f0 50 00 00       	push   $0x50f0
      39:	6a 01                	push   $0x1
      3b:	e8 60 36 00 00       	call   36a0 <printf>
    exit();
...
00000114 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     11a:	68 18 3a 00 00       	push   $0x3a18
     11f:	ff 35 a4 51 00 00    	push   0x51a4
     125:	e8 76 35 00 00       	call   36a0 <printf>
  if(mkdir("iputdir") < 0){
     12a:	c7 04 24 ab 39 00 00 	movl   $0x39ab,(%esp)
  ...
  if(chdir("iputdir") < 0){
     ...
     140:	68 ab 39 00 00       	push   $0x39ab
  ...
  if(unlink("../iputdir") < 0){
     ...
     158:	68 a8 39 00 00       	push   $0x39a8
  ...
  if(chdir("/") < 0){
     ...
     16c:	68 cd 39 00 00       	push   $0x39cd
  ...
  printf(stdout, "iput test ok\n");
     ...
     180:	68 50 3a 00 00       	push   $0x3a50
     185:	ff 35 a4 51 00 00    	push   0x51a4
     18b:	e8 10 35 00 00       	call   36a0 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     195:	50                   	push   %eax
     196:	50                   	push   %eax
     197:	68 84 39 00 00       	push   $0x3984
     19c:	ff 35 a4 51 00 00    	push   0x51a4
     1a2:	e8 f9 34 00 00       	call   36a0 <printf>
    exit();
     1a7:	e8 c3 33 00 00       	call   356f <exit>
    printf(stdout, "chdir / failed\n");
     1ac:	50                   	push   %eax
     1ad:	50                   	push   %eax
     1ae:	68 cf 39 00 00       	push   $0x39cf
     1b3:	ff 35 a4 51 00 00    	push   0x51a4
     1b9:	e8 e2 34 00 00       	call   36a0 <printf>
    exit();
     1be:	e8 ac 33 00 00       	call   356f <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1c3:	52                   	push   %edx
     1c4:	52                   	push   %edx
     1c5:	68 b3 39 00 00       	push   $0x39b3
     1ca:	ff 35 a4 51 00 00    	push   0x51a4
     1d0:	e8 cb 34 00 00       	call   36a0 <printf>
    exit();
     1d5:	e8 95 33 00 00       	call   356f <exit>
    printf(stdout, "chdir iputdir failed\n");
     1da:	51                   	push   %ecx
     1db:	51                   	push   %ecx
     1dc:	68 92 39 00 00       	push   $0x3992
     1e1:	ff 35 a4 51 00 00    	push   0x51a4
     1e7:	e8 b4 34 00 00       	call   36a0 <printf>
    exit();
...
000001f4 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     1fa:	68 df 39 00 00       	push   $0x39df
     1ff:	ff 35 a4 51 00 00    	push   0x51a4
     205:	e8 96 34 00 00       	call   36a0 <printf>
  pid = fork();
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     21f:	68 ab 39 00 00       	push   $0x39ab
    ...
    if(chdir("iputdir") < 0){
     ...
     237:	68 ab 39 00 00       	push   $0x39ab
    ...
    if(unlink("../iputdir") < 0){
     ...
     24f:	68 a8 39 00 00       	push   $0x39a8
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     270:	68 02 3a 00 00       	push   $0x3a02
     275:	ff 35 a4 51 00 00    	push   0x51a4
     27b:	e8 20 34 00 00       	call   36a0 <printf>
}
     ...
     28b:	68 b3 39 00 00       	push   $0x39b3
     290:	ff 35 a4 51 00 00    	push   0x51a4
     296:	e8 05 34 00 00       	call   36a0 <printf>
      exit();
     29b:	e8 cf 32 00 00       	call   356f <exit>
    printf(stdout, "fork failed\n");
     2a0:	51                   	push   %ecx
     2a1:	51                   	push   %ecx
     2a2:	68 c5 48 00 00       	push   $0x48c5
     2a7:	ff 35 a4 51 00 00    	push   0x51a4
     2ad:	e8 ee 33 00 00       	call   36a0 <printf>
    exit();
     2b2:	e8 b8 32 00 00       	call   356f <exit>
      printf(stdout, "mkdir failed\n");
     2b7:	52                   	push   %edx
     2b8:	52                   	push   %edx
     2b9:	68 84 39 00 00       	push   $0x3984
     2be:	ff 35 a4 51 00 00    	push   0x51a4
     2c4:	e8 d7 33 00 00       	call   36a0 <printf>
      exit();
     2c9:	e8 a1 32 00 00       	call   356f <exit>
      printf(stdout, "child chdir failed\n");
     2ce:	50                   	push   %eax
     2cf:	50                   	push   %eax
     2d0:	68 ee 39 00 00       	push   $0x39ee
     2d5:	ff 35 a4 51 00 00    	push   0x51a4
     2db:	e8 c0 33 00 00       	call   36a0 <printf>
      exit();
...
000002e8 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     2ee:	68 14 3a 00 00       	push   $0x3a14
     2f3:	ff 35 a4 51 00 00    	push   0x51a4
     2f9:	e8 a2 33 00 00       	call   36a0 <printf>
  if(mkdir("oidir") < 0){
     2fe:	c7 04 24 23 3a 00 00 	movl   $0x3a23,(%esp)
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     323:	6a 02                	push   $0x2
     325:	68 23 3a 00 00       	push   $0x3a23
    ...
    if(fd >= 0){
     ...
     339:	68 a8 49 00 00       	push   $0x49a8
     33e:	ff 35 a4 51 00 00    	push   0x51a4
     344:	e8 57 33 00 00       	call   36a0 <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
     35a:	c7 04 24 23 3a 00 00 	movl   $0x3a23,(%esp)
  ...
  printf(stdout, "openiput test ok\n");
     ...
     375:	68 4c 3a 00 00       	push   $0x3a4c
     37a:	ff 35 a4 51 00 00    	push   0x51a4
     380:	e8 1b 33 00 00       	call   36a0 <printf>
}
    ...
    printf(stdout, "fork failed\n");
     391:	52                   	push   %edx
     392:	52                   	push   %edx
     393:	68 c5 48 00 00       	push   $0x48c5
     398:	ff 35 a4 51 00 00    	push   0x51a4
     39e:	e8 fd 32 00 00       	call   36a0 <printf>
    exit();
     3a3:	e8 c7 31 00 00       	call   356f <exit>
    printf(stdout, "mkdir oidir failed\n");
     3a8:	51                   	push   %ecx
     3a9:	51                   	push   %ecx
     3aa:	68 29 3a 00 00       	push   $0x3a29
     3af:	ff 35 a4 51 00 00    	push   0x51a4
     3b5:	e8 e6 32 00 00       	call   36a0 <printf>
    exit();
     3ba:	e8 b0 31 00 00       	call   356f <exit>
    printf(stdout, "unlink failed\n");
     3bf:	50                   	push   %eax
     3c0:	50                   	push   %eax
     3c1:	68 3d 3a 00 00       	push   $0x3a3d
     3c6:	ff 35 a4 51 00 00    	push   0x51a4
     3cc:	e8 cf 32 00 00       	call   36a0 <printf>
    exit();
...
000003d8 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     3de:	68 5e 3a 00 00       	push   $0x3a5e
     3e3:	ff 35 a4 51 00 00    	push   0x51a4
     3e9:	e8 b2 32 00 00       	call   36a0 <printf>
  fd = open("echo", 0);
     3ee:	58                   	pop    %eax
     3ef:	5a                   	pop    %edx
     3f0:	6a 00                	push   $0x0
     3f2:	68 69 3a 00 00       	push   $0x3a69
  ...
  fd = open("doesnotexist", 0);
     ...
     40d:	59                   	pop    %ecx
     40e:	6a 00                	push   $0x0
     410:	68 81 3a 00 00       	push   $0x3a81
  ...
  printf(stdout, "open test ok\n");
     ...
     424:	68 ac 3a 00 00       	push   $0x3aac
     429:	ff 35 a4 51 00 00    	push   0x51a4
     42f:	e8 6c 32 00 00       	call   36a0 <printf>
}
    ...
    printf(stdout, "open echo failed!\n");
     439:	50                   	push   %eax
     43a:	50                   	push   %eax
     43b:	68 6e 3a 00 00       	push   $0x3a6e
     440:	ff 35 a4 51 00 00    	push   0x51a4
     446:	e8 55 32 00 00       	call   36a0 <printf>
    exit();
     44b:	e8 1f 31 00 00       	call   356f <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     450:	50                   	push   %eax
     451:	50                   	push   %eax
     452:	68 8e 3a 00 00       	push   $0x3a8e
     457:	ff 35 a4 51 00 00    	push   0x51a4
     45d:	e8 3e 32 00 00       	call   36a0 <printf>
    exit();
...
00000468 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     470:	68 ba 3a 00 00       	push   $0x3aba
     475:	ff 35 a4 51 00 00    	push   0x51a4
     47b:	e8 20 32 00 00       	call   36a0 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     480:	5a                   	pop    %edx
     481:	59                   	pop    %ecx
     482:	68 02 02 00 00       	push   $0x202
     487:	68 cb 3a 00 00       	push   $0x3acb
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4a1:	68 d1 3a 00 00       	push   $0x3ad1
     4a6:	ff 35 a4 51 00 00    	push   0x51a4
     4ac:	e8 ef 31 00 00       	call   36a0 <printf>
  ...
  for(i = 0; i < 100; i++){
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     4b8:	50                   	push   %eax
     4b9:	6a 0a                	push   $0xa
     4bb:	68 08 3b 00 00       	push   $0x3b08
     4c0:	56                   	push   %esi
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     4d2:	50                   	push   %eax
     4d3:	6a 0a                	push   $0xa
     4d5:	68 13 3b 00 00       	push   $0x3b13
     4da:	56                   	push   %esi
  ...
  printf(stdout, "writes ok\n");
     ...
     4f5:	68 1e 3b 00 00       	push   $0x3b1e
     4fa:	ff 35 a4 51 00 00    	push   0x51a4
     500:	e8 9b 31 00 00       	call   36a0 <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     50e:	5e                   	pop    %esi
     50f:	6a 00                	push   $0x0
     511:	68 cb 3a 00 00       	push   $0x3acb
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     52b:	68 29 3b 00 00       	push   $0x3b29
     530:	ff 35 a4 51 00 00    	push   0x51a4
     536:	e8 65 31 00 00       	call   36a0 <printf>
  i = read(fd, buf, 2000);
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     55f:	68 5d 3b 00 00       	push   $0x3b5d
     564:	ff 35 a4 51 00 00    	push   0x51a4
     56a:	e8 31 31 00 00       	call   36a0 <printf>
  close(fd);
     56f:	89 1c 24             	mov    %ebx,(%esp)
     572:	e8 20 30 00 00       	call   3597 <close>
  if(unlink("small") < 0){
     577:	c7 04 24 cb 3a 00 00 	movl   $0x3acb,(%esp)
  ...
  printf(stdout, "small file test ok\n");
     ...
     58d:	68 85 3b 00 00       	push   $0x3b85
     592:	ff 35 a4 51 00 00    	push   0x51a4
     598:	e8 03 31 00 00       	call   36a0 <printf>
}
     ...
     5a7:	50                   	push   %eax
     5a8:	53                   	push   %ebx
     5a9:	68 cc 49 00 00       	push   $0x49cc
     5ae:	ff 35 a4 51 00 00    	push   0x51a4
     5b4:	e8 e7 30 00 00       	call   36a0 <printf>
      exit();
     5b9:	e8 b1 2f 00 00       	call   356f <exit>
      printf(stdout, "error: write bb %d new file failed\n", i);
     5be:	50                   	push   %eax
     5bf:	53                   	push   %ebx
     5c0:	68 f0 49 00 00       	push   $0x49f0
     5c5:	ff 35 a4 51 00 00    	push   0x51a4
     5cb:	e8 d0 30 00 00       	call   36a0 <printf>
      exit();
     5d0:	e8 9a 2f 00 00       	call   356f <exit>
    printf(stdout, "error: open small failed!\n");
     5d5:	51                   	push   %ecx
     5d6:	51                   	push   %ecx
     5d7:	68 42 3b 00 00       	push   $0x3b42
     5dc:	ff 35 a4 51 00 00    	push   0x51a4
     5e2:	e8 b9 30 00 00       	call   36a0 <printf>
    exit();
     5e7:	e8 83 2f 00 00       	call   356f <exit>
    printf(stdout, "read failed\n");
     5ec:	52                   	push   %edx
     5ed:	52                   	push   %edx
     5ee:	68 89 3e 00 00       	push   $0x3e89
     5f3:	ff 35 a4 51 00 00    	push   0x51a4
     5f9:	e8 a2 30 00 00       	call   36a0 <printf>
    exit();
     5fe:	e8 6c 2f 00 00       	call   356f <exit>
    printf(stdout, "unlink small failed\n");
     603:	50                   	push   %eax
     604:	50                   	push   %eax
     605:	68 70 3b 00 00       	push   $0x3b70
     60a:	ff 35 a4 51 00 00    	push   0x51a4
     610:	e8 8b 30 00 00       	call   36a0 <printf>
    exit();
     615:	e8 55 2f 00 00       	call   356f <exit>
    printf(stdout, "error: creat small failed!\n");
     61a:	50                   	push   %eax
     61b:	50                   	push   %eax
     61c:	68 ec 3a 00 00       	push   $0x3aec
     621:	ff 35 a4 51 00 00    	push   0x51a4
     627:	e8 74 30 00 00       	call   36a0 <printf>
    exit();
...
00000634 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     63c:	68 99 3b 00 00       	push   $0x3b99
     641:	ff 35 a4 51 00 00    	push   0x51a4
     647:	e8 54 30 00 00       	call   36a0 <printf>
  fd = open("big", O_CREATE|O_RDWR);
     64c:	58                   	pop    %eax
     64d:	5a                   	pop    %edx
     64e:	68 02 02 00 00       	push   $0x202
     653:	68 13 3c 00 00       	push   $0x3c13
  ...
  fd = open("big", O_RDONLY);
     ...
     6a4:	5a                   	pop    %edx
     6a5:	6a 00                	push   $0x0
     6a7:	68 13 3c 00 00       	push   $0x3c13
  ...
  if(unlink("big") < 0){
     706:	c7 04 24 13 3c 00 00 	movl   $0x3c13,(%esp)
  ...
  printf(stdout, "big files ok\n");
     ...
     720:	68 3a 3c 00 00       	push   $0x3c3a
     725:	ff 35 a4 51 00 00    	push   0x51a4
     72b:	e8 70 2f 00 00       	call   36a0 <printf>
}
     ...
     73a:	51                   	push   %ecx
     73b:	53                   	push   %ebx
     73c:	68 c3 3b 00 00       	push   $0x3bc3
     741:	ff 35 a4 51 00 00    	push   0x51a4
     747:	e8 54 2f 00 00       	call   36a0 <printf>
      exit();
     74c:	e8 1e 2e 00 00       	call   356f <exit>
      printf(stdout, "read content of block %d is %d\n",
     751:	50                   	push   %eax
     752:	53                   	push   %ebx
     753:	68 14 4a 00 00       	push   $0x4a14
     758:	ff 35 a4 51 00 00    	push   0x51a4
     75e:	e8 3d 2f 00 00       	call   36a0 <printf>
      exit();
     763:	e8 07 2e 00 00       	call   356f <exit>
      printf(stdout, "read failed %d\n", i);
     768:	52                   	push   %edx
     769:	50                   	push   %eax
     76a:	68 17 3c 00 00       	push   $0x3c17
     76f:	ff 35 a4 51 00 00    	push   0x51a4
     775:	e8 26 2f 00 00       	call   36a0 <printf>
      exit();
     77a:	e8 f0 2d 00 00       	call   356f <exit>
        printf(stdout, "read only %d blocks from big", n);
     77f:	51                   	push   %ecx
     780:	68 8b 00 00 00       	push   $0x8b
     785:	68 fa 3b 00 00       	push   $0x3bfa
     78a:	ff 35 a4 51 00 00    	push   0x51a4
     790:	e8 0b 2f 00 00       	call   36a0 <printf>
        exit();
     795:	e8 d5 2d 00 00       	call   356f <exit>
    printf(stdout, "error: open big failed!\n");
     79a:	50                   	push   %eax
     79b:	50                   	push   %eax
     79c:	68 e1 3b 00 00       	push   $0x3be1
     7a1:	ff 35 a4 51 00 00    	push   0x51a4
     7a7:	e8 f4 2e 00 00       	call   36a0 <printf>
    exit();
     7ac:	e8 be 2d 00 00       	call   356f <exit>
    printf(stdout, "error: creat big failed!\n");
     7b1:	50                   	push   %eax
     7b2:	50                   	push   %eax
     7b3:	68 a9 3b 00 00       	push   $0x3ba9
     7b8:	ff 35 a4 51 00 00    	push   0x51a4
     7be:	e8 dd 2e 00 00       	call   36a0 <printf>
    exit();
     7c3:	e8 a7 2d 00 00       	call   356f <exit>
    printf(stdout, "unlink big failed\n");
     7c8:	50                   	push   %eax
     7c9:	50                   	push   %eax
     7ca:	68 27 3c 00 00       	push   $0x3c27
     7cf:	ff 35 a4 51 00 00    	push   0x51a4
     7d5:	e8 c6 2e 00 00       	call   36a0 <printf>
    exit();
...
000007e0 <createtest>:
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     7e7:	68 34 4a 00 00       	push   $0x4a34
     7ec:	ff 35 a4 51 00 00    	push   0x51a4
     7f2:	e8 a9 2e 00 00       	call   36a0 <printf>
  name[0] = 'a';
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     867:	68 5c 4a 00 00       	push   $0x4a5c
     86c:	ff 35 a4 51 00 00    	push   0x51a4
     872:	e8 29 2e 00 00       	call   36a0 <printf>
}
...
00000880 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     886:	68 48 3c 00 00       	push   $0x3c48
     88b:	ff 35 a4 51 00 00    	push   0x51a4
     891:	e8 0a 2e 00 00       	call   36a0 <printf>
  if(mkdir("dir0") < 0){
     896:	c7 04 24 54 3c 00 00 	movl   $0x3c54,(%esp)
  ...
  if(chdir("dir0") < 0){
     ...
     8ac:	68 54 3c 00 00       	push   $0x3c54
  ...
  if(chdir("..") < 0){
     ...
     8c4:	68 f9 41 00 00       	push   $0x41f9
  ...
  if(unlink("dir0") < 0){
     ...
     8d8:	68 54 3c 00 00       	push   $0x3c54
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     8ec:	68 91 3c 00 00       	push   $0x3c91
     8f1:	ff 35 a4 51 00 00    	push   0x51a4
     8f7:	e8 a4 2d 00 00       	call   36a0 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     901:	50                   	push   %eax
     902:	50                   	push   %eax
     903:	68 84 39 00 00       	push   $0x3984
     908:	ff 35 a4 51 00 00    	push   0x51a4
     90e:	e8 8d 2d 00 00       	call   36a0 <printf>
    exit();
     913:	e8 57 2c 00 00       	call   356f <exit>
    printf(stdout, "unlink dir0 failed\n");
     918:	50                   	push   %eax
     919:	50                   	push   %eax
     91a:	68 7d 3c 00 00       	push   $0x3c7d
     91f:	ff 35 a4 51 00 00    	push   0x51a4
     925:	e8 76 2d 00 00       	call   36a0 <printf>
    exit();
     92a:	e8 40 2c 00 00       	call   356f <exit>
    printf(stdout, "chdir .. failed\n");
     92f:	52                   	push   %edx
     930:	52                   	push   %edx
     931:	68 6c 3c 00 00       	push   $0x3c6c
     936:	ff 35 a4 51 00 00    	push   0x51a4
     93c:	e8 5f 2d 00 00       	call   36a0 <printf>
    exit();
     941:	e8 29 2c 00 00       	call   356f <exit>
    printf(stdout, "chdir dir0 failed\n");
     946:	51                   	push   %ecx
     947:	51                   	push   %ecx
     948:	68 59 3c 00 00       	push   $0x3c59
     94d:	ff 35 a4 51 00 00    	push   0x51a4
     953:	e8 48 2d 00 00       	call   36a0 <printf>
    exit();
...
00000960 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     966:	68 a0 3c 00 00       	push   $0x3ca0
     96b:	ff 35 a4 51 00 00    	push   0x51a4
     971:	e8 2a 2d 00 00       	call   36a0 <printf>
  if(exec("echo", echoargv) < 0){
     976:	5a                   	pop    %edx
     977:	59                   	pop    %ecx
     978:	68 a8 51 00 00       	push   $0x51a8
     97d:	68 69 3a 00 00       	push   $0x3a69
    ...
    printf(stdout, "exec echo failed\n");
     990:	50                   	push   %eax
     991:	50                   	push   %eax
     992:	68 ab 3c 00 00       	push   $0x3cab
     997:	ff 35 a4 51 00 00    	push   0x51a4
     99d:	e8 fe 2c 00 00       	call   36a0 <printf>
    exit();
...
000009a8 <pipe1>:
{
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a3b:	68 da 3c 00 00       	push   $0x3cda
     a40:	6a 01                	push   $0x1
     a42:	e8 59 2c 00 00       	call   36a0 <printf>
  ...
  printf(1, "pipe1 ok\n");
     abe:	5a                   	pop    %edx
     abf:	59                   	pop    %ecx
     ac0:	68 ff 3c 00 00       	push   $0x3cff
     ac5:	6a 01                	push   $0x1
     ac7:	e8 d4 2b 00 00       	call   36a0 <printf>
     acc:	83 c4 10             	add    $0x10,%esp
     acf:	e9 76 ff ff ff       	jmp    a4a <pipe1+0xa2>
      printf(1, "pipe1 oops 3 total %d\n", total);
     ad4:	53                   	push   %ebx
     ad5:	ff 75 d4             	push   -0x2c(%ebp)
     ad8:	68 e8 3c 00 00       	push   $0x3ce8
     add:	6a 01                	push   $0x1
     adf:	e8 bc 2b 00 00       	call   36a0 <printf>
      exit();
     ae4:	e8 86 2a 00 00       	call   356f <exit>
    printf(1, "pipe() failed\n");
     ae9:	50                   	push   %eax
     aea:	50                   	push   %eax
     aeb:	68 bd 3c 00 00       	push   $0x3cbd
     af0:	6a 01                	push   $0x1
     af2:	e8 a9 2b 00 00       	call   36a0 <printf>
    exit();
     af7:	e8 73 2a 00 00       	call   356f <exit>
    printf(1, "fork() failed\n");
     afc:	50                   	push   %eax
     afd:	50                   	push   %eax
     afe:	68 09 3d 00 00       	push   $0x3d09
     b03:	6a 01                	push   $0x1
     b05:	e8 96 2b 00 00       	call   36a0 <printf>
    exit();
     b0a:	e8 60 2a 00 00       	call   356f <exit>
        printf(1, "pipe1 oops 1\n");
     b0f:	50                   	push   %eax
     b10:	50                   	push   %eax
     b11:	68 cc 3c 00 00       	push   $0x3ccc
     b16:	6a 01                	push   $0x1
     b18:	e8 83 2b 00 00       	call   36a0 <printf>
        exit();
...
00000b24 <preempt>:
{
  ...
  printf(1, "preempt: ");
     b2d:	68 18 3d 00 00       	push   $0x3d18
     b32:	6a 01                	push   $0x1
     b34:	e8 67 2b 00 00       	call   36a0 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     b80:	6a 01                	push   $0x1
     b82:	68 dd 42 00 00       	push   $0x42dd
  ...
  printf(1, "kill... ");
     bdd:	58                   	pop    %eax
     bde:	5a                   	pop    %edx
     bdf:	68 49 3d 00 00       	push   $0x3d49
     be4:	6a 01                	push   $0x1
     be6:	e8 b5 2a 00 00       	call   36a0 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     c03:	59                   	pop    %ecx
     c04:	5b                   	pop    %ebx
     c05:	68 52 3d 00 00       	push   $0x3d52
     c0a:	6a 01                	push   $0x1
     c0c:	e8 8f 2a 00 00       	call   36a0 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     c20:	5e                   	pop    %esi
     c21:	5f                   	pop    %edi
     c22:	68 5b 3d 00 00       	push   $0x3d5b
     c27:	6a 01                	push   $0x1
     c29:	e8 72 2a 00 00       	call   36a0 <printf>
    ...
    printf(1, "preempt read error");
     ...
     c3c:	68 36 3d 00 00       	push   $0x3d36
     c41:	6a 01                	push   $0x1
     c43:	e8 58 2a 00 00       	call   36a0 <printf>
     c48:	83 c4 10             	add    $0x10,%esp
     c4b:	eb e4                	jmp    c31 <preempt+0x10d>
      printf(1, "preempt write error");
     c4d:	83 ec 08             	sub    $0x8,%esp
     c50:	68 22 3d 00 00       	push   $0x3d22
     c55:	6a 01                	push   $0x1
     c57:	e8 44 2a 00 00       	call   36a0 <printf>
...
00000c64 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     c8c:	68 c5 48 00 00       	push   $0x48c5
     c91:	6a 01                	push   $0x1
     c93:	e8 08 2a 00 00       	call   36a0 <printf>
      return;
     ...
     ca7:	68 67 3d 00 00       	push   $0x3d67
     cac:	6a 01                	push   $0x1
     cae:	e8 ed 29 00 00       	call   36a0 <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     cc0:	68 77 3d 00 00       	push   $0x3d77
     cc5:	6a 01                	push   $0x1
     cc7:	e8 d4 29 00 00       	call   36a0 <printf>
...
00000cdc <mem>:
{
  ...
  printf(1, "mem test\n");
     ...
     ce4:	68 84 3d 00 00       	push   $0x3d84
     ce9:	6a 01                	push   $0x1
     ceb:	e8 b0 29 00 00       	call   36a0 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d18:	e8 6f 2b 00 00       	call   388c <malloc>
    ...
    while(m1){
     ...
     d2f:	50                   	push   %eax
     d30:	e8 cf 2a 00 00       	call   3804 <free>
    while(m1){
    ...
    m1 = malloc(1024*20);
     ...
     d44:	e8 43 2b 00 00       	call   388c <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     d53:	50                   	push   %eax
     d54:	e8 ab 2a 00 00       	call   3804 <free>
    printf(1, "mem ok\n");
     d59:	58                   	pop    %eax
     d5a:	5a                   	pop    %edx
     d5b:	68 a8 3d 00 00       	push   $0x3da8
     d60:	6a 01                	push   $0x1
     d62:	e8 39 29 00 00       	call   36a0 <printf>
    exit();
     d67:	e8 03 28 00 00       	call   356f <exit>
      printf(1, "couldn't allocate mem?!!\n");
     d6c:	83 ec 08             	sub    $0x8,%esp
     d6f:	68 8e 3d 00 00       	push   $0x3d8e
     d74:	6a 01                	push   $0x1
     d76:	e8 25 29 00 00       	call   36a0 <printf>
      kill(ppid);
...
00000d94 <sharedfd>:
{
  ...
  printf(1, "sharedfd test\n");
     d9d:	68 b0 3d 00 00       	push   $0x3db0
     da2:	6a 01                	push   $0x1
     da4:	e8 f7 28 00 00       	call   36a0 <printf>
  unlink("sharedfd");
     da9:	c7 04 24 bf 3d 00 00 	movl   $0x3dbf,(%esp)
     db0:	e8 0a 28 00 00       	call   35bf <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     db5:	59                   	pop    %ecx
     db6:	5b                   	pop    %ebx
     db7:	68 02 02 00 00       	push   $0x202
     dbc:	68 bf 3d 00 00       	push   $0x3dbf
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     e18:	68 b0 4a 00 00       	push   $0x4ab0
     e1d:	6a 01                	push   $0x1
     e1f:	e8 7c 28 00 00       	call   36a0 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     e41:	59                   	pop    %ecx
     e42:	6a 00                	push   $0x0
     e44:	68 bf 3d 00 00       	push   $0x3dbf
  ...
  unlink("sharedfd");
     ea3:	c7 04 24 bf 3d 00 00 	movl   $0x3dbf,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     ec8:	68 c8 3d 00 00       	push   $0x3dc8
     ecd:	6a 01                	push   $0x1
     ecf:	e8 cc 27 00 00       	call   36a0 <printf>
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     ee2:	68 84 4a 00 00       	push   $0x4a84
     ee7:	6a 01                	push   $0x1
     ee9:	e8 b2 27 00 00       	call   36a0 <printf>
    return;
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     efc:	68 d0 4a 00 00       	push   $0x4ad0
     f01:	6a 01                	push   $0x1
     f03:	e8 98 27 00 00       	call   36a0 <printf>
    return;
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     f18:	52                   	push   %edx
     f19:	57                   	push   %edi
     f1a:	68 d5 3d 00 00       	push   $0x3dd5
     f1f:	6a 01                	push   $0x1
     f21:	e8 7a 27 00 00       	call   36a0 <printf>
    exit();
...
00000f2c <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
     f35:	be 1c 51 00 00       	mov    $0x511c,%esi
     f3a:	b9 04 00 00 00       	mov    $0x4,%ecx
     f3f:	8d 7d d8             	lea    -0x28(%ebp),%edi
     f42:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  printf(1, "fourfiles test\n");
     f44:	68 ea 3d 00 00       	push   $0x3dea
     f49:	6a 01                	push   $0x1
     f4b:	e8 50 27 00 00       	call   36a0 <printf>
  ...
  printf(1, "fourfiles ok\n");
    ...
    101a:	68 28 3e 00 00       	push   $0x3e28
    101f:	6a 01                	push   $0x1
    1021:	e8 7a 26 00 00       	call   36a0 <printf>
}
    ...
    103e:	68 0b 3e 00 00       	push   $0x3e0b
    1043:	6a 01                	push   $0x1
    1045:	e8 56 26 00 00       	call   36a0 <printf>
          exit();
    ...
    10a5:	50                   	push   %eax
    10a6:	50                   	push   %eax
    10a7:	68 8b 40 00 00       	push   $0x408b
    10ac:	6a 01                	push   $0x1
    10ae:	e8 ed 25 00 00       	call   36a0 <printf>
        exit();
    10b3:	e8 b7 24 00 00       	call   356f <exit>
      printf(1, "fork failed\n");
    10b8:	83 ec 08             	sub    $0x8,%esp
    10bb:	68 c5 48 00 00       	push   $0x48c5
    10c0:	6a 01                	push   $0x1
    10c2:	e8 d9 25 00 00       	call   36a0 <printf>
      exit();
    10c7:	e8 a3 24 00 00       	call   356f <exit>
      printf(1, "wrong length %d\n", total);
    10cc:	50                   	push   %eax
    10cd:	ff 75 d4             	push   -0x2c(%ebp)
    10d0:	68 17 3e 00 00       	push   $0x3e17
    10d5:	6a 01                	push   $0x1
    10d7:	e8 c4 25 00 00       	call   36a0 <printf>
      exit();
    10dc:	e8 8e 24 00 00       	call   356f <exit>
          printf(1, "write failed %d\n", n);
    10e1:	51                   	push   %ecx
    10e2:	50                   	push   %eax
    10e3:	68 fa 3d 00 00       	push   $0x3dfa
    10e8:	6a 01                	push   $0x1
    10ea:	e8 b1 25 00 00       	call   36a0 <printf>
          exit();
...
000010f4 <createdelete>:
{
  ...
  printf(1, "createdelete test\n");
    10fd:	68 3c 3e 00 00       	push   $0x3e3c
    1102:	6a 01                	push   $0x1
    1104:	e8 97 25 00 00       	call   36a0 <printf>
  ...
  printf(1, "createdelete ok\n");
    ...
    11bc:	68 4f 3e 00 00       	push   $0x3e4f
    11c1:	6a 01                	push   $0x1
    11c3:	e8 d8 24 00 00       	call   36a0 <printf>
}
    ...
    11d4:	50                   	push   %eax
    11d5:	57                   	push   %edi
    11d6:	68 20 4b 00 00       	push   $0x4b20
    11db:	6a 01                	push   $0x1
    11dd:	e8 be 24 00 00       	call   36a0 <printf>
        exit();
    ...
    1254:	51                   	push   %ecx
    1255:	51                   	push   %ecx
    1256:	68 3d 3a 00 00       	push   $0x3a3d
    125b:	6a 01                	push   $0x1
    125d:	e8 3e 24 00 00       	call   36a0 <printf>
            exit();
    ...
    1268:	52                   	push   %edx
    1269:	57                   	push   %edi
    126a:	68 fc 4a 00 00       	push   $0x4afc
    126f:	6a 01                	push   $0x1
    1271:	e8 2a 24 00 00       	call   36a0 <printf>
        exit();
    1276:	e8 f4 22 00 00       	call   356f <exit>
      printf(1, "fork failed\n");
    127b:	83 ec 08             	sub    $0x8,%esp
    127e:	68 c5 48 00 00       	push   $0x48c5
    1283:	6a 01                	push   $0x1
    1285:	e8 16 24 00 00       	call   36a0 <printf>
      exit();
    128a:	e8 e0 22 00 00       	call   356f <exit>
          printf(1, "create failed\n");
    128f:	83 ec 08             	sub    $0x8,%esp
    1292:	68 8b 40 00 00       	push   $0x408b
    1297:	6a 01                	push   $0x1
    1299:	e8 02 24 00 00       	call   36a0 <printf>
          exit();
...
000012a4 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    12ac:	68 60 3e 00 00       	push   $0x3e60
    12b1:	6a 01                	push   $0x1
    12b3:	e8 e8 23 00 00       	call   36a0 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    12b8:	5e                   	pop    %esi
    12b9:	58                   	pop    %eax
    12ba:	68 02 02 00 00       	push   $0x202
    12bf:	68 71 3e 00 00       	push   $0x3e71
  ...
  write(fd, "hello", 5);
    12d6:	50                   	push   %eax
    12d7:	6a 05                	push   $0x5
    12d9:	68 96 3e 00 00       	push   $0x3e96
    12de:	53                   	push   %ebx
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12ed:	59                   	pop    %ecx
    12ee:	6a 02                	push   $0x2
    12f0:	68 71 3e 00 00       	push   $0x3e71
  ...
  if(unlink("unlinkread") != 0){
    ...
    130a:	68 71 3e 00 00       	push   $0x3e71
  ...
  unlink("unlinkread");
    1392:	c7 04 24 71 3e 00 00 	movl   $0x3e71,(%esp)
    1399:	e8 21 22 00 00       	call   35bf <unlink>
  printf(1, "unlinkread ok\n");
    139e:	58                   	pop    %eax
    139f:	5a                   	pop    %edx
    13a0:	68 19 3f 00 00       	push   $0x3f19
    13a5:	6a 01                	push   $0x1
    13a7:	e8 f4 22 00 00       	call   36a0 <printf>
}
    ...
    13b6:	53                   	push   %ebx
    13b7:	53                   	push   %ebx
    13b8:	68 7c 3e 00 00       	push   $0x3e7c
    13bd:	6a 01                	push   $0x1
    13bf:	e8 dc 22 00 00       	call   36a0 <printf>
    exit();
    13c4:	e8 a6 21 00 00       	call   356f <exit>
    printf(1, "unlinkread write failed\n");
    13c9:	51                   	push   %ecx
    13ca:	51                   	push   %ecx
    13cb:	68 00 3f 00 00       	push   $0x3f00
    13d0:	6a 01                	push   $0x1
    13d2:	e8 c9 22 00 00       	call   36a0 <printf>
    exit();
    13d7:	e8 93 21 00 00       	call   356f <exit>
    printf(1, "unlinkread wrong data\n");
    13dc:	50                   	push   %eax
    13dd:	50                   	push   %eax
    13de:	68 e9 3e 00 00       	push   $0x3ee9
    13e3:	6a 01                	push   $0x1
    13e5:	e8 b6 22 00 00       	call   36a0 <printf>
    exit();
    13ea:	e8 80 21 00 00       	call   356f <exit>
    printf(1, "unlinkread read failed");
    13ef:	50                   	push   %eax
    13f0:	50                   	push   %eax
    13f1:	68 d2 3e 00 00       	push   $0x3ed2
    13f6:	6a 01                	push   $0x1
    13f8:	e8 a3 22 00 00       	call   36a0 <printf>
    exit();
    13fd:	e8 6d 21 00 00       	call   356f <exit>
    printf(1, "unlink unlinkread failed\n");
    1402:	50                   	push   %eax
    1403:	50                   	push   %eax
    1404:	68 b4 3e 00 00       	push   $0x3eb4
    1409:	6a 01                	push   $0x1
    140b:	e8 90 22 00 00       	call   36a0 <printf>
    exit();
    1410:	e8 5a 21 00 00       	call   356f <exit>
    printf(1, "open unlinkread failed\n");
    1415:	50                   	push   %eax
    1416:	50                   	push   %eax
    1417:	68 9c 3e 00 00       	push   $0x3e9c
    141c:	6a 01                	push   $0x1
    141e:	e8 7d 22 00 00       	call   36a0 <printf>
    exit();
...
00001428 <linktest>:
{
  ...
  printf(1, "linktest\n");
    142f:	68 28 3f 00 00       	push   $0x3f28
    1434:	6a 01                	push   $0x1
    1436:	e8 65 22 00 00       	call   36a0 <printf>
  unlink("lf1");
    143b:	c7 04 24 32 3f 00 00 	movl   $0x3f32,(%esp)
    1442:	e8 78 21 00 00       	call   35bf <unlink>
  unlink("lf2");
    1447:	c7 04 24 36 3f 00 00 	movl   $0x3f36,(%esp)
    144e:	e8 6c 21 00 00       	call   35bf <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
    1453:	58                   	pop    %eax
    1454:	5a                   	pop    %edx
    1455:	68 02 02 00 00       	push   $0x202
    145a:	68 32 3f 00 00       	push   $0x3f32
  ...
  if(write(fd, "hello", 5) != 5){
    1471:	50                   	push   %eax
    1472:	6a 05                	push   $0x5
    1474:	68 96 3e 00 00       	push   $0x3e96
    1479:	53                   	push   %ebx
  ...
  if(link("lf1", "lf2") < 0){
    1494:	5b                   	pop    %ebx
    1495:	58                   	pop    %eax
    1496:	68 36 3f 00 00       	push   $0x3f36
    149b:	68 32 3f 00 00       	push   $0x3f32
  ...
  unlink("lf1");
    ...
    14b3:	68 32 3f 00 00       	push   $0x3f32
    14b8:	e8 02 21 00 00       	call   35bf <unlink>
  if(open("lf1", 0) >= 0){
    14bd:	58                   	pop    %eax
    14be:	5a                   	pop    %edx
    14bf:	6a 00                	push   $0x0
    14c1:	68 32 3f 00 00       	push   $0x3f32
  ...
  fd = open("lf2", 0);
    ...
    14d9:	6a 00                	push   $0x0
    14db:	68 36 3f 00 00       	push   $0x3f36
  ...
  if(link("lf2", "lf2") >= 0){
    1518:	58                   	pop    %eax
    1519:	5a                   	pop    %edx
    151a:	68 36 3f 00 00       	push   $0x3f36
    151f:	68 36 3f 00 00       	push   $0x3f36
  ...
  unlink("lf2");
    ...
    1537:	68 36 3f 00 00       	push   $0x3f36
    153c:	e8 7e 20 00 00       	call   35bf <unlink>
  if(link("lf2", "lf1") >= 0){
    1541:	59                   	pop    %ecx
    1542:	5b                   	pop    %ebx
    1543:	68 32 3f 00 00       	push   $0x3f32
    1548:	68 36 3f 00 00       	push   $0x3f36
  ...
  if(link(".", "lf1") >= 0){
    ...
    155c:	68 32 3f 00 00       	push   $0x3f32
    1561:	68 fa 41 00 00       	push   $0x41fa
  ...
  printf(1, "linktest ok\n");
    ...
    1575:	68 d0 3f 00 00       	push   $0x3fd0
    157a:	6a 01                	push   $0x1
    157c:	e8 1f 21 00 00       	call   36a0 <printf>
}
    ...
    1589:	50                   	push   %eax
    158a:	50                   	push   %eax
    158b:	68 3a 3f 00 00       	push   $0x3f3a
    1590:	6a 01                	push   $0x1
    1592:	e8 09 21 00 00       	call   36a0 <printf>
    exit();
    1597:	e8 d3 1f 00 00       	call   356f <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    159c:	50                   	push   %eax
    159d:	50                   	push   %eax
    159e:	68 b4 3f 00 00       	push   $0x3fb4
    15a3:	6a 01                	push   $0x1
    15a5:	e8 f6 20 00 00       	call   36a0 <printf>
    exit();
    15aa:	e8 c0 1f 00 00       	call   356f <exit>
    printf(1, "link non-existant succeeded! oops\n");
    15af:	52                   	push   %edx
    15b0:	52                   	push   %edx
    15b1:	68 68 4b 00 00       	push   $0x4b68
    15b6:	6a 01                	push   $0x1
    15b8:	e8 e3 20 00 00       	call   36a0 <printf>
    exit();
    15bd:	e8 ad 1f 00 00       	call   356f <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15c2:	50                   	push   %eax
    15c3:	50                   	push   %eax
    15c4:	68 96 3f 00 00       	push   $0x3f96
    15c9:	6a 01                	push   $0x1
    15cb:	e8 d0 20 00 00       	call   36a0 <printf>
    exit();
    15d0:	e8 9a 1f 00 00       	call   356f <exit>
    printf(1, "read lf2 failed\n");
    15d5:	51                   	push   %ecx
    15d6:	51                   	push   %ecx
    15d7:	68 85 3f 00 00       	push   $0x3f85
    15dc:	6a 01                	push   $0x1
    15de:	e8 bd 20 00 00       	call   36a0 <printf>
    exit();
    15e3:	e8 87 1f 00 00       	call   356f <exit>
    printf(1, "open lf2 failed\n");
    15e8:	50                   	push   %eax
    15e9:	50                   	push   %eax
    15ea:	68 74 3f 00 00       	push   $0x3f74
    15ef:	6a 01                	push   $0x1
    15f1:	e8 aa 20 00 00       	call   36a0 <printf>
    exit();
    15f6:	e8 74 1f 00 00       	call   356f <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    15fb:	50                   	push   %eax
    15fc:	50                   	push   %eax
    15fd:	68 40 4b 00 00       	push   $0x4b40
    1602:	6a 01                	push   $0x1
    1604:	e8 97 20 00 00       	call   36a0 <printf>
    exit();
    1609:	e8 61 1f 00 00       	call   356f <exit>
    printf(1, "link lf1 lf2 failed\n");
    160e:	51                   	push   %ecx
    160f:	51                   	push   %ecx
    1610:	68 5f 3f 00 00       	push   $0x3f5f
    1615:	6a 01                	push   $0x1
    1617:	e8 84 20 00 00       	call   36a0 <printf>
    exit();
    161c:	e8 4e 1f 00 00       	call   356f <exit>
    printf(1, "write lf1 failed\n");
    1621:	50                   	push   %eax
    1622:	50                   	push   %eax
    1623:	68 4d 3f 00 00       	push   $0x3f4d
    1628:	6a 01                	push   $0x1
    162a:	e8 71 20 00 00       	call   36a0 <printf>
    exit();
...
00001634 <concreate>:
{
  ...
  printf(1, "concreate test\n");
    163d:	68 dd 3f 00 00       	push   $0x3fdd
    1642:	6a 01                	push   $0x1
    1644:	e8 57 20 00 00       	call   36a0 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    16dd:	51                   	push   %ecx
    16de:	53                   	push   %ebx
    16df:	68 f0 3f 00 00       	push   $0x3ff0
    16e4:	6a 01                	push   $0x1
    16e6:	e8 b5 1f 00 00       	call   36a0 <printf>
        exit();
    16eb:	e8 7f 1e 00 00       	call   356f <exit>
      link("C0", file);
    16f0:	83 ec 08             	sub    $0x8,%esp
    16f3:	53                   	push   %ebx
    16f4:	68 ed 3f 00 00       	push   $0x3fed
    ...
    170b:	53                   	push   %ebx
    170c:	68 ed 3f 00 00       	push   $0x3fed
  ...
  fd = open(".", 0);
    ...
    1737:	5a                   	pop    %edx
    1738:	6a 00                	push   $0x0
    173a:	68 fa 41 00 00       	push   $0x41fa
  ...
  printf(1, "concreate ok\n");
    ...
    187b:	68 42 40 00 00       	push   $0x4042
    1880:	6a 01                	push   $0x1
    1882:	e8 19 1e 00 00       	call   36a0 <printf>
}
    ...
    1892:	68 c5 48 00 00       	push   $0x48c5
    1897:	6a 01                	push   $0x1
    1899:	e8 02 1e 00 00       	call   36a0 <printf>
      exit();
    189e:	e8 cc 1c 00 00       	call   356f <exit>
    printf(1, "concreate not enough files in directory listing\n");
    18a3:	51                   	push   %ecx
    18a4:	51                   	push   %ecx
    18a5:	68 8c 4b 00 00       	push   $0x4b8c
    18aa:	6a 01                	push   $0x1
    18ac:	e8 ef 1d 00 00       	call   36a0 <printf>
    exit();
    ...
    18ba:	50                   	push   %eax
    18bb:	68 25 40 00 00       	push   $0x4025
    18c0:	6a 01                	push   $0x1
    18c2:	e8 d9 1d 00 00       	call   36a0 <printf>
        exit();
    ...
    18d0:	50                   	push   %eax
    18d1:	68 0c 40 00 00       	push   $0x400c
    18d6:	6a 01                	push   $0x1
    18d8:	e8 c3 1d 00 00       	call   36a0 <printf>
        exit();
...
000018f4 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    18fd:	68 50 40 00 00       	push   $0x4050
    1902:	6a 01                	push   $0x1
    1904:	e8 97 1d 00 00       	call   36a0 <printf>
  unlink("x");
    1909:	c7 04 24 dd 42 00 00 	movl   $0x42dd,(%esp)
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    194a:	68 dd 42 00 00       	push   $0x42dd
  ...
  for(i = 0; i < 100; i++){
    ...
    1994:	68 dd 42 00 00       	push   $0x42dd
  ...
  printf(1, "linkunlink ok\n");
    ...
    19bb:	68 65 40 00 00       	push   $0x4065
    19c0:	6a 01                	push   $0x1
    19c2:	e8 d9 1c 00 00       	call   36a0 <printf>
}
    ...
    19d3:	68 dd 42 00 00       	push   $0x42dd
    19d8:	68 61 40 00 00       	push   $0x4061
    ...
    19ea:	52                   	push   %edx
    19eb:	52                   	push   %edx
    19ec:	68 c5 48 00 00       	push   $0x48c5
    19f1:	6a 01                	push   $0x1
    19f3:	e8 a8 1c 00 00       	call   36a0 <printf>
    exit();
...
00001a04 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    1a0d:	68 74 40 00 00       	push   $0x4074
    1a12:	6a 01                	push   $0x1
    1a14:	e8 87 1c 00 00       	call   36a0 <printf>
  unlink("bd");
    1a19:	c7 04 24 81 40 00 00 	movl   $0x4081,(%esp)
    1a20:	e8 9a 1b 00 00       	call   35bf <unlink>
  fd = open("bd", O_CREATE);
    1a25:	5a                   	pop    %edx
    1a26:	59                   	pop    %ecx
    1a27:	68 00 02 00 00       	push   $0x200
    1a2c:	68 81 40 00 00       	push   $0x4081
  ...
  for(i = 0; i < 500; i++){
    ...
    1a75:	57                   	push   %edi
    1a76:	68 81 40 00 00       	push   $0x4081
  ...
  unlink("bd");
    ...
    1a95:	68 81 40 00 00       	push   $0x4081
  ...
  printf(1, "bigdir ok\n");
    ...
    1ade:	68 c3 40 00 00       	push   $0x40c3
    1ae3:	6a 01                	push   $0x1
    1ae5:	e8 b6 1b 00 00       	call   36a0 <printf>
    ...
    1af8:	68 9a 40 00 00       	push   $0x409a
    1afd:	6a 01                	push   $0x1
    1aff:	e8 9c 1b 00 00       	call   36a0 <printf>
      exit();
    1b04:	e8 66 1a 00 00       	call   356f <exit>
      printf(1, "bigdir unlink failed");
    1b09:	83 ec 08             	sub    $0x8,%esp
    1b0c:	68 ae 40 00 00       	push   $0x40ae
    1b11:	6a 01                	push   $0x1
    1b13:	e8 88 1b 00 00       	call   36a0 <printf>
      exit();
    1b18:	e8 52 1a 00 00       	call   356f <exit>
    printf(1, "bigdir create failed\n");
    1b1d:	50                   	push   %eax
    1b1e:	50                   	push   %eax
    1b1f:	68 84 40 00 00       	push   $0x4084
    1b24:	6a 01                	push   $0x1
    1b26:	e8 75 1b 00 00       	call   36a0 <printf>
    exit();
...
00001b30 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    1b37:	68 ce 40 00 00       	push   $0x40ce
    1b3c:	6a 01                	push   $0x1
    1b3e:	e8 5d 1b 00 00       	call   36a0 <printf>
  unlink("ff");
    1b43:	c7 04 24 57 41 00 00 	movl   $0x4157,(%esp)
    1b4a:	e8 70 1a 00 00       	call   35bf <unlink>
  if(mkdir("dd") != 0){
    1b4f:	c7 04 24 f4 41 00 00 	movl   $0x41f4,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1b6e:	68 2d 41 00 00       	push   $0x412d
  ...
  write(fd, "ff", 2);
    1b85:	50                   	push   %eax
    1b86:	6a 02                	push   $0x2
    1b88:	68 57 41 00 00       	push   $0x4157
    1b8d:	53                   	push   %ebx
  ...
  if(unlink("dd") >= 0){
    1b9b:	c7 04 24 f4 41 00 00 	movl   $0x41f4,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1bb5:	68 08 41 00 00       	push   $0x4108
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1bd2:	68 2a 41 00 00       	push   $0x412a
  ...
  write(fd, "FF", 2);
    1be9:	50                   	push   %eax
    1bea:	6a 02                	push   $0x2
    1bec:	68 4b 41 00 00       	push   $0x414b
    1bf1:	53                   	push   %ebx
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1c00:	5a                   	pop    %edx
    1c01:	6a 00                	push   $0x0
    1c03:	68 4e 41 00 00       	push   $0x414e
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1c4d:	58                   	pop    %eax
    1c4e:	5a                   	pop    %edx
    1c4f:	68 8e 41 00 00       	push   $0x418e
    1c54:	68 2a 41 00 00       	push   $0x412a
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1c6c:	68 2a 41 00 00       	push   $0x412a
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1c84:	6a 00                	push   $0x0
    1c86:	68 2a 41 00 00       	push   $0x412a
  ...
  if(chdir("dd") != 0){
    ...
    1c9e:	68 f4 41 00 00       	push   $0x41f4
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1cb6:	68 c2 41 00 00       	push   $0x41c2
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1cce:	68 e8 41 00 00       	push   $0x41e8
  ...
  if(chdir("./..") != 0){
    ...
    1ce6:	68 f7 41 00 00       	push   $0x41f7
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1cfe:	6a 00                	push   $0x0
    1d00:	68 8e 41 00 00       	push   $0x418e
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1d3e:	5a                   	pop    %edx
    1d3f:	6a 00                	push   $0x0
    1d41:	68 2a 41 00 00       	push   $0x412a
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1d5e:	68 42 42 00 00       	push   $0x4242
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1d7b:	68 67 42 00 00       	push   $0x4267
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1d98:	68 f4 41 00 00       	push   $0x41f4
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1db0:	6a 02                	push   $0x2
    1db2:	68 f4 41 00 00       	push   $0x41f4
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1dca:	6a 01                	push   $0x1
    1dcc:	68 f4 41 00 00       	push   $0x41f4
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1de4:	68 d6 42 00 00       	push   $0x42d6
    1de9:	68 42 42 00 00       	push   $0x4242
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1e01:	68 d6 42 00 00       	push   $0x42d6
    1e06:	68 67 42 00 00       	push   $0x4267
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    1e1e:	68 8e 41 00 00       	push   $0x418e
    1e23:	68 2d 41 00 00       	push   $0x412d
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    1e3b:	68 42 42 00 00       	push   $0x4242
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    1e53:	68 67 42 00 00       	push   $0x4267
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    1e6b:	68 8e 41 00 00       	push   $0x418e
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    1e83:	68 67 42 00 00       	push   $0x4267
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    1e9b:	68 42 42 00 00       	push   $0x4242
  ...
  if(chdir("dd/ff") == 0){
    ...
    1eb3:	68 2d 41 00 00       	push   $0x412d
  ...
  if(chdir("dd/xx") == 0){
    ...
    1ecb:	68 d9 42 00 00       	push   $0x42d9
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    1ee3:	68 8e 41 00 00       	push   $0x418e
  ...
  if(unlink("dd/ff") != 0){
    ...
    1efb:	68 2d 41 00 00       	push   $0x412d
  ...
  if(unlink("dd") == 0){
    ...
    1f13:	68 f4 41 00 00       	push   $0x41f4
  ...
  if(unlink("dd/dd") < 0){
    ...
    1f2b:	68 09 41 00 00       	push   $0x4109
  ...
  if(unlink("dd") < 0){
    ...
    1f43:	68 f4 41 00 00       	push   $0x41f4
  ...
  printf(1, "subdir ok\n");
    ...
    1f5b:	68 d6 43 00 00       	push   $0x43d6
    1f60:	6a 01                	push   $0x1
    1f62:	e8 39 17 00 00       	call   36a0 <printf>
}
    ...
    1f6f:	51                   	push   %ecx
    1f70:	51                   	push   %ecx
    1f71:	68 73 41 00 00       	push   $0x4173
    1f76:	6a 01                	push   $0x1
    1f78:	e8 23 17 00 00       	call   36a0 <printf>
    exit();
    1f7d:	e8 ed 15 00 00       	call   356f <exit>
    printf(1, "chdir dd/../../dd failed\n");
    1f82:	50                   	push   %eax
    1f83:	50                   	push   %eax
    1f84:	68 ce 41 00 00       	push   $0x41ce
    1f89:	6a 01                	push   $0x1
    1f8b:	e8 10 17 00 00       	call   36a0 <printf>
    exit();
    1f90:	e8 da 15 00 00       	call   356f <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    1f95:	51                   	push   %ecx
    1f96:	51                   	push   %ecx
    1f97:	68 99 41 00 00       	push   $0x4199
    1f9c:	6a 01                	push   $0x1
    1f9e:	e8 fd 16 00 00       	call   36a0 <printf>
    exit();
    1fa3:	e8 c7 15 00 00       	call   356f <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    1fa8:	51                   	push   %ecx
    1fa9:	51                   	push   %ecx
    1faa:	68 4b 42 00 00       	push   $0x424b
    1faf:	6a 01                	push   $0x1
    1fb1:	e8 ea 16 00 00       	call   36a0 <printf>
    exit();
    1fb6:	e8 b4 15 00 00       	call   356f <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    1fbb:	53                   	push   %ebx
    1fbc:	53                   	push   %ebx
    1fbd:	68 30 4c 00 00       	push   $0x4c30
    1fc2:	6a 01                	push   $0x1
    1fc4:	e8 d7 16 00 00       	call   36a0 <printf>
    exit();
    1fc9:	e8 a1 15 00 00       	call   356f <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    1fce:	51                   	push   %ecx
    1fcf:	51                   	push   %ecx
    1fd0:	68 df 42 00 00       	push   $0x42df
    1fd5:	6a 01                	push   $0x1
    1fd7:	e8 c4 16 00 00       	call   36a0 <printf>
    exit();
    1fdc:	e8 8e 15 00 00       	call   356f <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    1fe1:	53                   	push   %ebx
    1fe2:	53                   	push   %ebx
    1fe3:	68 a0 4c 00 00       	push   $0x4ca0
    1fe8:	6a 01                	push   $0x1
    1fea:	e8 b1 16 00 00       	call   36a0 <printf>
    exit();
    1fef:	e8 7b 15 00 00       	call   356f <exit>
    printf(1, "open dd/dd/../ff failed\n");
    1ff4:	50                   	push   %eax
    1ff5:	50                   	push   %eax
    1ff6:	68 5a 41 00 00       	push   $0x415a
    1ffb:	6a 01                	push   $0x1
    1ffd:	e8 9e 16 00 00       	call   36a0 <printf>
    exit();
    2002:	e8 68 15 00 00       	call   356f <exit>
    printf(1, "create dd/dd/ff failed\n");
    2007:	51                   	push   %ecx
    2008:	51                   	push   %ecx
    2009:	68 33 41 00 00       	push   $0x4133
    200e:	6a 01                	push   $0x1
    2010:	e8 8b 16 00 00       	call   36a0 <printf>
    exit();
    2015:	e8 55 15 00 00       	call   356f <exit>
    printf(1, "chdir ./.. failed\n");
    201a:	50                   	push   %eax
    201b:	50                   	push   %eax
    201c:	68 fc 41 00 00       	push   $0x41fc
    2021:	6a 01                	push   $0x1
    2023:	e8 78 16 00 00       	call   36a0 <printf>
    exit();
    2028:	e8 42 15 00 00       	call   356f <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    202d:	53                   	push   %ebx
    202e:	53                   	push   %ebx
    202f:	68 e8 4b 00 00       	push   $0x4be8
    2034:	6a 01                	push   $0x1
    2036:	e8 65 16 00 00       	call   36a0 <printf>
    exit();
    203b:	e8 2f 15 00 00       	call   356f <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2040:	50                   	push   %eax
    2041:	50                   	push   %eax
    2042:	68 7c 4c 00 00       	push   $0x4c7c
    2047:	6a 01                	push   $0x1
    2049:	e8 52 16 00 00       	call   36a0 <printf>
    exit();
    204e:	e8 1c 15 00 00       	call   356f <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    2053:	50                   	push   %eax
    2054:	50                   	push   %eax
    2055:	68 58 4c 00 00       	push   $0x4c58
    205a:	6a 01                	push   $0x1
    205c:	e8 3f 16 00 00       	call   36a0 <printf>
    exit();
    2061:	e8 09 15 00 00       	call   356f <exit>
    printf(1, "open dd wronly succeeded!\n");
    2066:	50                   	push   %eax
    2067:	50                   	push   %eax
    2068:	68 bb 42 00 00       	push   $0x42bb
    206d:	6a 01                	push   $0x1
    206f:	e8 2c 16 00 00       	call   36a0 <printf>
    exit();
    2074:	e8 f6 14 00 00       	call   356f <exit>
    printf(1, "open dd rdwr succeeded!\n");
    2079:	50                   	push   %eax
    207a:	50                   	push   %eax
    207b:	68 a2 42 00 00       	push   $0x42a2
    2080:	6a 01                	push   $0x1
    2082:	e8 19 16 00 00       	call   36a0 <printf>
    exit();
    2087:	e8 e3 14 00 00       	call   356f <exit>
    printf(1, "create dd succeeded!\n");
    208c:	50                   	push   %eax
    208d:	50                   	push   %eax
    208e:	68 8c 42 00 00       	push   $0x428c
    2093:	6a 01                	push   $0x1
    2095:	e8 06 16 00 00       	call   36a0 <printf>
    exit();
    209a:	e8 d0 14 00 00       	call   356f <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    209f:	52                   	push   %edx
    20a0:	52                   	push   %edx
    20a1:	68 70 42 00 00       	push   $0x4270
    20a6:	6a 01                	push   $0x1
    20a8:	e8 f3 15 00 00       	call   36a0 <printf>
    exit();
    20ad:	e8 bd 14 00 00       	call   356f <exit>
    printf(1, "chdir dd failed\n");
    20b2:	50                   	push   %eax
    20b3:	50                   	push   %eax
    20b4:	68 b1 41 00 00       	push   $0x41b1
    20b9:	6a 01                	push   $0x1
    20bb:	e8 e0 15 00 00       	call   36a0 <printf>
    exit();
    20c0:	e8 aa 14 00 00       	call   356f <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    20c5:	52                   	push   %edx
    20c6:	52                   	push   %edx
    20c7:	68 0c 4c 00 00       	push   $0x4c0c
    20cc:	6a 01                	push   $0x1
    20ce:	e8 cd 15 00 00       	call   36a0 <printf>
    exit();
    20d3:	e8 97 14 00 00       	call   356f <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    20d8:	53                   	push   %ebx
    20d9:	53                   	push   %ebx
    20da:	68 0f 41 00 00       	push   $0x410f
    20df:	6a 01                	push   $0x1
    20e1:	e8 ba 15 00 00       	call   36a0 <printf>
    exit();
    20e6:	e8 84 14 00 00       	call   356f <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    20eb:	50                   	push   %eax
    20ec:	50                   	push   %eax
    20ed:	68 c0 4b 00 00       	push   $0x4bc0
    20f2:	6a 01                	push   $0x1
    20f4:	e8 a7 15 00 00       	call   36a0 <printf>
    exit();
    20f9:	e8 71 14 00 00       	call   356f <exit>
    printf(1, "create dd/ff failed\n");
    20fe:	50                   	push   %eax
    20ff:	50                   	push   %eax
    2100:	68 f3 40 00 00       	push   $0x40f3
    2105:	6a 01                	push   $0x1
    2107:	e8 94 15 00 00       	call   36a0 <printf>
    exit();
    210c:	e8 5e 14 00 00       	call   356f <exit>
    printf(1, "subdir mkdir dd failed\n");
    2111:	50                   	push   %eax
    2112:	50                   	push   %eax
    2113:	68 db 40 00 00       	push   $0x40db
    2118:	6a 01                	push   $0x1
    211a:	e8 81 15 00 00       	call   36a0 <printf>
    exit();
    211f:	e8 4b 14 00 00       	call   356f <exit>
    printf(1, "unlink dd failed\n");
    2124:	50                   	push   %eax
    2125:	50                   	push   %eax
    2126:	68 c4 43 00 00       	push   $0x43c4
    212b:	6a 01                	push   $0x1
    212d:	e8 6e 15 00 00       	call   36a0 <printf>
    exit();
    2132:	e8 38 14 00 00       	call   356f <exit>
    printf(1, "unlink dd/dd failed\n");
    2137:	52                   	push   %edx
    2138:	52                   	push   %edx
    2139:	68 af 43 00 00       	push   $0x43af
    213e:	6a 01                	push   $0x1
    2140:	e8 5b 15 00 00       	call   36a0 <printf>
    exit();
    2145:	e8 25 14 00 00       	call   356f <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    214a:	51                   	push   %ecx
    214b:	51                   	push   %ecx
    214c:	68 c4 4c 00 00       	push   $0x4cc4
    2151:	6a 01                	push   $0x1
    2153:	e8 48 15 00 00       	call   36a0 <printf>
    exit();
    2158:	e8 12 14 00 00       	call   356f <exit>
    printf(1, "unlink dd/ff failed\n");
    215d:	53                   	push   %ebx
    215e:	53                   	push   %ebx
    215f:	68 9a 43 00 00       	push   $0x439a
    2164:	6a 01                	push   $0x1
    2166:	e8 35 15 00 00       	call   36a0 <printf>
    exit();
    216b:	e8 ff 13 00 00       	call   356f <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    2170:	50                   	push   %eax
    2171:	50                   	push   %eax
    2172:	68 82 43 00 00       	push   $0x4382
    2177:	6a 01                	push   $0x1
    2179:	e8 22 15 00 00       	call   36a0 <printf>
    exit();
    217e:	e8 ec 13 00 00       	call   356f <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    2183:	50                   	push   %eax
    2184:	50                   	push   %eax
    2185:	68 6a 43 00 00       	push   $0x436a
    218a:	6a 01                	push   $0x1
    218c:	e8 0f 15 00 00       	call   36a0 <printf>
    exit();
    2191:	e8 d9 13 00 00       	call   356f <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    2196:	50                   	push   %eax
    2197:	50                   	push   %eax
    2198:	68 4e 43 00 00       	push   $0x434e
    219d:	6a 01                	push   $0x1
    219f:	e8 fc 14 00 00       	call   36a0 <printf>
    exit();
    21a4:	e8 c6 13 00 00       	call   356f <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    21a9:	50                   	push   %eax
    21aa:	50                   	push   %eax
    21ab:	68 32 43 00 00       	push   $0x4332
    21b0:	6a 01                	push   $0x1
    21b2:	e8 e9 14 00 00       	call   36a0 <printf>
    exit();
    21b7:	e8 b3 13 00 00       	call   356f <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    21bc:	50                   	push   %eax
    21bd:	50                   	push   %eax
    21be:	68 15 43 00 00       	push   $0x4315
    21c3:	6a 01                	push   $0x1
    21c5:	e8 d6 14 00 00       	call   36a0 <printf>
    exit();
    21ca:	e8 a0 13 00 00       	call   356f <exit>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    21cf:	52                   	push   %edx
    21d0:	52                   	push   %edx
    21d1:	68 fa 42 00 00       	push   $0x42fa
    21d6:	6a 01                	push   $0x1
    21d8:	e8 c3 14 00 00       	call   36a0 <printf>
    exit();
    21dd:	e8 8d 13 00 00       	call   356f <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    21e2:	51                   	push   %ecx
    21e3:	51                   	push   %ecx
    21e4:	68 27 42 00 00       	push   $0x4227
    21e9:	6a 01                	push   $0x1
    21eb:	e8 b0 14 00 00       	call   36a0 <printf>
    exit();
    21f0:	e8 7a 13 00 00       	call   356f <exit>
    printf(1, "open dd/dd/ffff failed\n");
    21f5:	50                   	push   %eax
    21f6:	50                   	push   %eax
    21f7:	68 0f 42 00 00       	push   $0x420f
    21fc:	6a 01                	push   $0x1
    21fe:	e8 9d 14 00 00       	call   36a0 <printf>
    exit();
...
00002208 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    2210:	68 e1 43 00 00       	push   $0x43e1
    2215:	6a 01                	push   $0x1
    2217:	e8 84 14 00 00       	call   36a0 <printf>
  unlink("bigwrite");
    221c:	c7 04 24 f0 43 00 00 	movl   $0x43f0,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2238:	68 f0 43 00 00       	push   $0x43f0
    ...
    unlink("bigwrite");
    227c:	c7 04 24 f0 43 00 00 	movl   $0x43f0,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    ...
    229c:	68 23 44 00 00       	push   $0x4423
    22a1:	6a 01                	push   $0x1
    22a3:	e8 f8 13 00 00       	call   36a0 <printf>
}
    ...
    22b2:	50                   	push   %eax
    22b3:	53                   	push   %ebx
    22b4:	68 11 44 00 00       	push   $0x4411
    22b9:	6a 01                	push   $0x1
    22bb:	e8 e0 13 00 00       	call   36a0 <printf>
        exit();
    22c0:	e8 aa 12 00 00       	call   356f <exit>
      printf(1, "cannot create bigwrite\n");
    22c5:	83 ec 08             	sub    $0x8,%esp
    22c8:	68 f9 43 00 00       	push   $0x43f9
    22cd:	6a 01                	push   $0x1
    22cf:	e8 cc 13 00 00       	call   36a0 <printf>
      exit();
...
000022dc <bigfile>:
{
  ...
  printf(1, "bigfile test\n");
    22e5:	68 30 44 00 00       	push   $0x4430
    22ea:	6a 01                	push   $0x1
    22ec:	e8 af 13 00 00       	call   36a0 <printf>
  unlink("bigfile");
    22f1:	c7 04 24 4c 44 00 00 	movl   $0x444c,(%esp)
    22f8:	e8 c2 12 00 00       	call   35bf <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    22fd:	5e                   	pop    %esi
    22fe:	5f                   	pop    %edi
    22ff:	68 02 02 00 00       	push   $0x202
    2304:	68 4c 44 00 00       	push   $0x444c
  ...
  fd = open("bigfile", 0);
    ...
    2362:	5a                   	pop    %edx
    2363:	6a 00                	push   $0x0
    2365:	68 4c 44 00 00       	push   $0x444c
  ...
  unlink("bigfile");
    ...
    23e5:	68 4c 44 00 00       	push   $0x444c
    23ea:	e8 d0 11 00 00       	call   35bf <unlink>
  printf(1, "bigfile test ok\n");
    23ef:	58                   	pop    %eax
    23f0:	5a                   	pop    %edx
    23f1:	68 db 44 00 00       	push   $0x44db
    23f6:	6a 01                	push   $0x1
    23f8:	e8 a3 12 00 00       	call   36a0 <printf>
}
    ...
    240b:	68 a8 44 00 00       	push   $0x44a8
    2410:	6a 01                	push   $0x1
    2412:	e8 89 12 00 00       	call   36a0 <printf>
      exit();
    2417:	e8 53 11 00 00       	call   356f <exit>
      printf(1, "short read bigfile\n");
    241c:	83 ec 08             	sub    $0x8,%esp
    241f:	68 94 44 00 00       	push   $0x4494
    2424:	6a 01                	push   $0x1
    2426:	e8 75 12 00 00       	call   36a0 <printf>
      exit();
    242b:	e8 3f 11 00 00       	call   356f <exit>
      printf(1, "read bigfile failed\n");
    2430:	83 ec 08             	sub    $0x8,%esp
    2433:	68 7f 44 00 00       	push   $0x447f
    2438:	6a 01                	push   $0x1
    243a:	e8 61 12 00 00       	call   36a0 <printf>
      exit();
    243f:	e8 2b 11 00 00       	call   356f <exit>
      printf(1, "write bigfile failed\n");
    2444:	83 ec 08             	sub    $0x8,%esp
    2447:	68 54 44 00 00       	push   $0x4454
    244c:	6a 01                	push   $0x1
    244e:	e8 4d 12 00 00       	call   36a0 <printf>
      exit();
    2453:	e8 17 11 00 00       	call   356f <exit>
    printf(1, "cannot open bigfile\n");
    2458:	50                   	push   %eax
    2459:	50                   	push   %eax
    245a:	68 6a 44 00 00       	push   $0x446a
    245f:	6a 01                	push   $0x1
    2461:	e8 3a 12 00 00       	call   36a0 <printf>
    exit();
    2466:	e8 04 11 00 00       	call   356f <exit>
    printf(1, "cannot create bigfile");
    246b:	53                   	push   %ebx
    246c:	53                   	push   %ebx
    246d:	68 3e 44 00 00       	push   $0x443e
    2472:	6a 01                	push   $0x1
    2474:	e8 27 12 00 00       	call   36a0 <printf>
    exit();
    2479:	e8 f1 10 00 00       	call   356f <exit>
    printf(1, "read bigfile wrong total\n");
    247e:	51                   	push   %ecx
    247f:	51                   	push   %ecx
    2480:	68 c1 44 00 00       	push   $0x44c1
    2485:	6a 01                	push   $0x1
    2487:	e8 14 12 00 00       	call   36a0 <printf>
    exit();
...
00002494 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    249a:	68 ec 44 00 00       	push   $0x44ec
    249f:	6a 01                	push   $0x1
    24a1:	e8 fa 11 00 00       	call   36a0 <printf>
  if(mkdir("12345678901234") != 0){
    24a6:	c7 04 24 27 45 00 00 	movl   $0x4527,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    24c0:	68 e4 4c 00 00       	push   $0x4ce4
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    24dd:	68 34 4d 00 00       	push   $0x4d34
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    24fc:	5a                   	pop    %edx
    24fd:	6a 00                	push   $0x0
    24ff:	68 a4 4d 00 00       	push   $0x4da4
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    2519:	c7 04 24 18 45 00 00 	movl   $0x4518,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    252f:	68 40 4e 00 00       	push   $0x4e40
  ...
  printf(1, "fourteen ok\n");
    ...
    2543:	68 36 45 00 00       	push   $0x4536
    2548:	6a 01                	push   $0x1
    254a:	e8 51 11 00 00       	call   36a0 <printf>
}
    ...
    2554:	50                   	push   %eax
    2555:	50                   	push   %eax
    2556:	68 fb 44 00 00       	push   $0x44fb
    255b:	6a 01                	push   $0x1
    255d:	e8 3e 11 00 00       	call   36a0 <printf>
    exit();
    2562:	e8 08 10 00 00       	call   356f <exit>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    2567:	50                   	push   %eax
    2568:	50                   	push   %eax
    2569:	68 60 4e 00 00       	push   $0x4e60
    256e:	6a 01                	push   $0x1
    2570:	e8 2b 11 00 00       	call   36a0 <printf>
    exit();
    2575:	e8 f5 0f 00 00       	call   356f <exit>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    257a:	52                   	push   %edx
    257b:	52                   	push   %edx
    257c:	68 10 4e 00 00       	push   $0x4e10
    2581:	6a 01                	push   $0x1
    2583:	e8 18 11 00 00       	call   36a0 <printf>
    exit();
    2588:	e8 e2 0f 00 00       	call   356f <exit>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    258d:	51                   	push   %ecx
    258e:	51                   	push   %ecx
    258f:	68 d4 4d 00 00       	push   $0x4dd4
    2594:	6a 01                	push   $0x1
    2596:	e8 05 11 00 00       	call   36a0 <printf>
    exit();
    259b:	e8 cf 0f 00 00       	call   356f <exit>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    25a0:	51                   	push   %ecx
    25a1:	51                   	push   %ecx
    25a2:	68 64 4d 00 00       	push   $0x4d64
    25a7:	6a 01                	push   $0x1
    25a9:	e8 f2 10 00 00       	call   36a0 <printf>
    exit();
    25ae:	e8 bc 0f 00 00       	call   356f <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    25b3:	50                   	push   %eax
    25b4:	50                   	push   %eax
    25b5:	68 04 4d 00 00       	push   $0x4d04
    25ba:	6a 01                	push   $0x1
    25bc:	e8 df 10 00 00       	call   36a0 <printf>
    exit();
...
000025c8 <rmdot>:
{
  ...
  printf(1, "rmdot test\n");
    25ce:	68 43 45 00 00       	push   $0x4543
    25d3:	6a 01                	push   $0x1
    25d5:	e8 c6 10 00 00       	call   36a0 <printf>
  if(mkdir("dots") != 0){
    25da:	c7 04 24 4f 45 00 00 	movl   $0x454f,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    25f4:	68 4f 45 00 00       	push   $0x454f
  ...
  if(unlink(".") == 0){
    ...
    260c:	68 fa 41 00 00       	push   $0x41fa
  ...
  if(unlink("..") == 0){
    ...
    2624:	68 f9 41 00 00       	push   $0x41f9
  ...
  if(chdir("/") != 0){
    ...
    263c:	68 cd 39 00 00       	push   $0x39cd
  ...
  if(unlink("dots/.") == 0){
    ...
    2654:	68 97 45 00 00       	push   $0x4597
  ...
  if(unlink("dots/..") == 0){
    ...
    2668:	68 b5 45 00 00       	push   $0x45b5
  ...
  if(unlink("dots") != 0){
    ...
    267c:	68 4f 45 00 00       	push   $0x454f
  ...
  printf(1, "rmdot ok\n");
    ...
    2690:	68 ea 45 00 00       	push   $0x45ea
    2695:	6a 01                	push   $0x1
    2697:	e8 04 10 00 00       	call   36a0 <printf>
}
    ...
    26a1:	50                   	push   %eax
    26a2:	50                   	push   %eax
    26a3:	68 54 45 00 00       	push   $0x4554
    26a8:	6a 01                	push   $0x1
    26aa:	e8 f1 0f 00 00       	call   36a0 <printf>
    exit();
    26af:	e8 bb 0e 00 00       	call   356f <exit>
    printf(1, "unlink dots failed!\n");
    26b4:	50                   	push   %eax
    26b5:	50                   	push   %eax
    26b6:	68 d5 45 00 00       	push   $0x45d5
    26bb:	6a 01                	push   $0x1
    26bd:	e8 de 0f 00 00       	call   36a0 <printf>
    exit();
    26c2:	e8 a8 0e 00 00       	call   356f <exit>
    printf(1, "unlink dots/.. worked!\n");
    26c7:	52                   	push   %edx
    26c8:	52                   	push   %edx
    26c9:	68 bd 45 00 00       	push   $0x45bd
    26ce:	6a 01                	push   $0x1
    26d0:	e8 cb 0f 00 00       	call   36a0 <printf>
    exit();
    26d5:	e8 95 0e 00 00       	call   356f <exit>
    printf(1, "unlink dots/. worked!\n");
    26da:	51                   	push   %ecx
    26db:	51                   	push   %ecx
    26dc:	68 9e 45 00 00       	push   $0x459e
    26e1:	6a 01                	push   $0x1
    26e3:	e8 b8 0f 00 00       	call   36a0 <printf>
    exit();
    26e8:	e8 82 0e 00 00       	call   356f <exit>
    printf(1, "chdir / failed\n");
    26ed:	50                   	push   %eax
    26ee:	50                   	push   %eax
    26ef:	68 cf 39 00 00       	push   $0x39cf
    26f4:	6a 01                	push   $0x1
    26f6:	e8 a5 0f 00 00       	call   36a0 <printf>
    exit();
    26fb:	e8 6f 0e 00 00       	call   356f <exit>
    printf(1, "rm .. worked!\n");
    2700:	50                   	push   %eax
    2701:	50                   	push   %eax
    2702:	68 88 45 00 00       	push   $0x4588
    2707:	6a 01                	push   $0x1
    2709:	e8 92 0f 00 00       	call   36a0 <printf>
    exit();
    270e:	e8 5c 0e 00 00       	call   356f <exit>
    printf(1, "rm . worked!\n");
    2713:	50                   	push   %eax
    2714:	50                   	push   %eax
    2715:	68 7a 45 00 00       	push   $0x457a
    271a:	6a 01                	push   $0x1
    271c:	e8 7f 0f 00 00       	call   36a0 <printf>
    exit();
    2721:	e8 49 0e 00 00       	call   356f <exit>
    printf(1, "chdir dots failed\n");
    2726:	50                   	push   %eax
    2727:	50                   	push   %eax
    2728:	68 67 45 00 00       	push   $0x4567
    272d:	6a 01                	push   $0x1
    272f:	e8 6c 0f 00 00       	call   36a0 <printf>
    exit();
...
0000273c <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    2743:	68 f4 45 00 00       	push   $0x45f4
    2748:	6a 01                	push   $0x1
    274a:	e8 51 0f 00 00       	call   36a0 <printf>
  fd = open("dirfile", O_CREATE);
    274f:	5b                   	pop    %ebx
    2750:	58                   	pop    %eax
    2751:	68 00 02 00 00       	push   $0x200
    2756:	68 01 46 00 00       	push   $0x4601
  ...
  if(chdir("dirfile") == 0){
    2774:	c7 04 24 01 46 00 00 	movl   $0x4601,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    278e:	6a 00                	push   $0x0
    2790:	68 3a 46 00 00       	push   $0x463a
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    27ad:	68 3a 46 00 00       	push   $0x463a
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    27c5:	68 3a 46 00 00       	push   $0x463a
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    27dd:	68 3a 46 00 00       	push   $0x463a
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    27f5:	68 3a 46 00 00       	push   $0x463a
    27fa:	68 9e 46 00 00       	push   $0x469e
  ...
  if(unlink("dirfile") != 0){
    ...
    2812:	68 01 46 00 00       	push   $0x4601
  ...
  fd = open(".", O_RDWR);
    ...
    282a:	6a 02                	push   $0x2
    282c:	68 fa 41 00 00       	push   $0x41fa
  ...
  printf(1, "dir vs file OK\n");
    2872:	58                   	pop    %eax
    2873:	5a                   	pop    %edx
    2874:	68 d1 46 00 00       	push   $0x46d1
    2879:	6a 01                	push   $0x1
    287b:	e8 20 0e 00 00       	call   36a0 <printf>
}
    ...
    2888:	50                   	push   %eax
    2889:	50                   	push   %eax
    288a:	68 45 46 00 00       	push   $0x4645
    288f:	6a 01                	push   $0x1
    2891:	e8 0a 0e 00 00       	call   36a0 <printf>
    exit();
    2896:	e8 d4 0c 00 00       	call   356f <exit>
    printf(1, "chdir dirfile succeeded!\n");
    289b:	52                   	push   %edx
    289c:	52                   	push   %edx
    289d:	68 20 46 00 00       	push   $0x4620
    28a2:	6a 01                	push   $0x1
    28a4:	e8 f7 0d 00 00       	call   36a0 <printf>
    exit();
    28a9:	e8 c1 0c 00 00       	call   356f <exit>
    printf(1, "create dirfile failed\n");
    28ae:	51                   	push   %ecx
    28af:	51                   	push   %ecx
    28b0:	68 09 46 00 00       	push   $0x4609
    28b5:	6a 01                	push   $0x1
    28b7:	e8 e4 0d 00 00       	call   36a0 <printf>
    exit();
    28bc:	e8 ae 0c 00 00       	call   356f <exit>
    printf(1, "write . succeeded!\n");
    28c1:	51                   	push   %ecx
    28c2:	51                   	push   %ecx
    28c3:	68 bd 46 00 00       	push   $0x46bd
    28c8:	6a 01                	push   $0x1
    28ca:	e8 d1 0d 00 00       	call   36a0 <printf>
    exit();
    28cf:	e8 9b 0c 00 00       	call   356f <exit>
    printf(1, "open . for writing succeeded!\n");
    28d4:	53                   	push   %ebx
    28d5:	53                   	push   %ebx
    28d6:	68 b4 4e 00 00       	push   $0x4eb4
    28db:	6a 01                	push   $0x1
    28dd:	e8 be 0d 00 00       	call   36a0 <printf>
    exit();
    28e2:	e8 88 0c 00 00       	call   356f <exit>
    printf(1, "unlink dirfile failed!\n");
    28e7:	50                   	push   %eax
    28e8:	50                   	push   %eax
    28e9:	68 a5 46 00 00       	push   $0x46a5
    28ee:	6a 01                	push   $0x1
    28f0:	e8 ab 0d 00 00       	call   36a0 <printf>
    exit();
    28f5:	e8 75 0c 00 00       	call   356f <exit>
    printf(1, "link to dirfile/xx succeeded!\n");
    28fa:	50                   	push   %eax
    28fb:	50                   	push   %eax
    28fc:	68 94 4e 00 00       	push   $0x4e94
    2901:	6a 01                	push   $0x1
    2903:	e8 98 0d 00 00       	call   36a0 <printf>
    exit();
    2908:	e8 62 0c 00 00       	call   356f <exit>
    printf(1, "unlink dirfile/xx succeeded!\n");
    290d:	50                   	push   %eax
    290e:	50                   	push   %eax
    290f:	68 80 46 00 00       	push   $0x4680
    2914:	6a 01                	push   $0x1
    2916:	e8 85 0d 00 00       	call   36a0 <printf>
    exit();
    291b:	e8 4f 0c 00 00       	call   356f <exit>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    2920:	50                   	push   %eax
    2921:	50                   	push   %eax
    2922:	68 63 46 00 00       	push   $0x4663
    2927:	6a 01                	push   $0x1
    2929:	e8 72 0d 00 00       	call   36a0 <printf>
    exit();
...
00002934 <iref>:
{
  ...
  printf(1, "empty file name\n");
    293b:	68 e1 46 00 00       	push   $0x46e1
    2940:	6a 01                	push   $0x1
    2942:	e8 59 0d 00 00       	call   36a0 <printf>
    2947:	83 c4 10             	add    $0x10,%esp
    294a:	bb 33 00 00 00       	mov    $0x33,%ebx
    294f:	90                   	nop
    if(mkdir("irefd") != 0){
    2950:	83 ec 0c             	sub    $0xc,%esp
    2953:	68 f2 46 00 00       	push   $0x46f2
    ...
    296b:	68 f2 46 00 00       	push   $0x46f2
    ...
    2983:	68 a7 3d 00 00       	push   $0x3da7
    2988:	e8 4a 0c 00 00       	call   35d7 <mkdir>
    link("README", "");
    298d:	59                   	pop    %ecx
    298e:	58                   	pop    %eax
    298f:	68 a7 3d 00 00       	push   $0x3da7
    2994:	68 9e 46 00 00       	push   $0x469e
    2999:	e8 31 0c 00 00       	call   35cf <link>
    fd = open("", O_CREATE);
    299e:	58                   	pop    %eax
    299f:	5a                   	pop    %edx
    29a0:	68 00 02 00 00       	push   $0x200
    29a5:	68 a7 3d 00 00       	push   $0x3da7
    ...
    29ca:	68 dc 42 00 00       	push   $0x42dc
    ...
    29ea:	68 dc 42 00 00       	push   $0x42dc
  ...
  chdir("/");
    ...
    2a01:	68 cd 39 00 00       	push   $0x39cd
    2a06:	e8 d4 0b 00 00       	call   35df <chdir>
  printf(1, "empty file name OK\n");
    2a0b:	58                   	pop    %eax
    2a0c:	5a                   	pop    %edx
    2a0d:	68 20 47 00 00       	push   $0x4720
    2a12:	6a 01                	push   $0x1
    2a14:	e8 87 0c 00 00       	call   36a0 <printf>
}
    ...
    2a24:	68 f8 46 00 00       	push   $0x46f8
    2a29:	6a 01                	push   $0x1
    2a2b:	e8 70 0c 00 00       	call   36a0 <printf>
      exit();
    2a30:	e8 3a 0b 00 00       	call   356f <exit>
      printf(1, "chdir irefd failed\n");
    2a35:	83 ec 08             	sub    $0x8,%esp
    2a38:	68 0c 47 00 00       	push   $0x470c
    2a3d:	6a 01                	push   $0x1
    2a3f:	e8 5c 0c 00 00       	call   36a0 <printf>
      exit();
...
00002a4c <forktest>:
{
  ...
  printf(1, "fork test\n");
    2a53:	68 34 47 00 00       	push   $0x4734
    2a58:	6a 01                	push   $0x1
    2a5a:	e8 41 0c 00 00       	call   36a0 <printf>
  ...
  printf(1, "fork test OK\n");
    ...
    2a97:	68 66 47 00 00       	push   $0x4766
    2a9c:	6a 01                	push   $0x1
    2a9e:	e8 fd 0b 00 00       	call   36a0 <printf>
}
    ...
    2ab0:	68 3f 47 00 00       	push   $0x473f
    2ab5:	6a 01                	push   $0x1
    2ab7:	e8 e4 0b 00 00       	call   36a0 <printf>
      exit();
    2abc:	e8 ae 0a 00 00       	call   356f <exit>
    printf(1, "wait got too many\n");
    2ac1:	52                   	push   %edx
    2ac2:	52                   	push   %edx
    2ac3:	68 53 47 00 00       	push   $0x4753
    2ac8:	6a 01                	push   $0x1
    2aca:	e8 d1 0b 00 00       	call   36a0 <printf>
    exit();
    2acf:	e8 9b 0a 00 00       	call   356f <exit>
    printf(1, "fork claimed to work 1000 times!\n");
    2ad4:	50                   	push   %eax
    2ad5:	50                   	push   %eax
    2ad6:	68 d4 4e 00 00       	push   $0x4ed4
    2adb:	6a 01                	push   $0x1
    2add:	e8 be 0b 00 00       	call   36a0 <printf>
    exit();
...
00002ae8 <sbrktest>:
{
  ...
  printf(stdout, "sbrk test\n");
    2af1:	68 74 47 00 00       	push   $0x4774
    2af6:	ff 35 a4 51 00 00    	push   0x51a4
    2afc:	e8 9f 0b 00 00       	call   36a0 <printf>
  oldbrk = sbrk(0);
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2d43:	68 1c 48 00 00       	push   $0x481c
    2d48:	ff 35 a4 51 00 00    	push   0x51a4
    2d4e:	e8 4d 09 00 00       	call   36a0 <printf>
}
    ...
    2d7c:	6a 01                	push   $0x1
    2d7e:	68 dd 42 00 00       	push   $0x42dd
    ...
    2dc2:	53                   	push   %ebx
    2dc3:	56                   	push   %esi
    2dc4:	68 7f 47 00 00       	push   $0x477f
    2dc9:	ff 35 a4 51 00 00    	push   0x51a4
    2dcf:	e8 cc 08 00 00       	call   36a0 <printf>
      exit();
    2dd4:	83 c4 20             	add    $0x20,%esp
    2dd7:	e8 93 07 00 00       	call   356f <exit>
      printf(stdout, "fork failed\n");
    2ddc:	83 ec 08             	sub    $0x8,%esp
    2ddf:	68 c5 48 00 00       	push   $0x48c5
    2de4:	ff 35 a4 51 00 00    	push   0x51a4
    2dea:	e8 b1 08 00 00       	call   36a0 <printf>
      exit();
    ...
    2df7:	50                   	push   %eax
    2df8:	53                   	push   %ebx
    2df9:	68 e8 47 00 00       	push   $0x47e8
    2dfe:	ff 35 a4 51 00 00    	push   0x51a4
    2e04:	e8 97 08 00 00       	call   36a0 <printf>
      kill(ppid);
    ...
    2e16:	50                   	push   %eax
    2e17:	53                   	push   %ebx
    2e18:	68 c8 4f 00 00       	push   $0x4fc8
    2e1d:	ff 35 a4 51 00 00    	push   0x51a4
    2e23:	e8 78 08 00 00       	call   36a0 <printf>
    exit();
    2e28:	e8 42 07 00 00       	call   356f <exit>
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    2e2d:	57                   	push   %edi
    2e2e:	57                   	push   %edi
    2e2f:	68 f8 4e 00 00       	push   $0x4ef8
    2e34:	ff 35 a4 51 00 00    	push   0x51a4
    2e3a:	e8 61 08 00 00       	call   36a0 <printf>
    exit();
    2e3f:	e8 2b 07 00 00       	call   356f <exit>
    printf(stdout, "sbrk test fork failed\n");
    2e44:	50                   	push   %eax
    2e45:	50                   	push   %eax
    2e46:	68 9a 47 00 00       	push   $0x479a
    2e4b:	ff 35 a4 51 00 00    	push   0x51a4
    2e51:	e8 4a 08 00 00       	call   36a0 <printf>
    exit();
    2e56:	e8 14 07 00 00       	call   356f <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    2e5b:	53                   	push   %ebx
    2e5c:	53                   	push   %ebx
    2e5d:	68 98 4f 00 00       	push   $0x4f98
    2e62:	ff 35 a4 51 00 00    	push   0x51a4
    2e68:	e8 33 08 00 00       	call   36a0 <printf>
    exit();
    2e6d:	e8 fd 06 00 00       	call   356f <exit>
    printf(stdout, "failed sbrk leaked memory\n");
    2e72:	50                   	push   %eax
    2e73:	50                   	push   %eax
    2e74:	68 01 48 00 00       	push   $0x4801
    2e79:	ff 35 a4 51 00 00    	push   0x51a4
    2e7f:	e8 1c 08 00 00       	call   36a0 <printf>
    exit();
    2e84:	e8 e6 06 00 00       	call   356f <exit>
    printf(1, "pipe() failed\n");
    2e89:	51                   	push   %ecx
    2e8a:	51                   	push   %ecx
    2e8b:	68 bd 3c 00 00       	push   $0x3cbd
    2e90:	6a 01                	push   $0x1
    2e92:	e8 09 08 00 00       	call   36a0 <printf>
    exit();
    ...
    2ea1:	50                   	push   %eax
    2ea2:	50                   	push   %eax
    2ea3:	68 b1 47 00 00       	push   $0x47b1
    2ea8:	ff 35 a4 51 00 00    	push   0x51a4
    2eae:	e8 ed 07 00 00       	call   36a0 <printf>
    exit();
    2eb3:	e8 b7 06 00 00       	call   356f <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    2eb8:	56                   	push   %esi
    2eb9:	53                   	push   %ebx
    2eba:	68 70 4f 00 00       	push   $0x4f70
    2ebf:	ff 35 a4 51 00 00    	push   0x51a4
    2ec5:	e8 d6 07 00 00       	call   36a0 <printf>
    exit();
    2eca:	e8 a0 06 00 00       	call   356f <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    2ecf:	50                   	push   %eax
    2ed0:	53                   	push   %ebx
    2ed1:	68 38 4f 00 00       	push   $0x4f38
    2ed6:	ff 35 a4 51 00 00    	push   0x51a4
    2edc:	e8 bf 07 00 00       	call   36a0 <printf>
    exit();
    2ee1:	e8 89 06 00 00       	call   356f <exit>
    printf(stdout, "sbrk could not deallocate\n");
    2ee6:	56                   	push   %esi
    2ee7:	56                   	push   %esi
    2ee8:	68 cd 47 00 00       	push   $0x47cd
    2eed:	ff 35 a4 51 00 00    	push   0x51a4
    2ef3:	e8 a8 07 00 00       	call   36a0 <printf>
    exit();
...
00002f04 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    2f0c:	68 2a 48 00 00       	push   $0x482a
    2f11:	ff 35 a4 51 00 00    	push   0x51a4
    2f17:	e8 84 07 00 00       	call   36a0 <printf>
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    2f53:	5a                   	pop    %edx
    2f54:	56                   	push   %esi
    2f55:	68 39 48 00 00       	push   $0x4839
  ...
  printf(stdout, "validate ok\n");
    ...
    2f76:	68 5d 48 00 00       	push   $0x485d
    2f7b:	ff 35 a4 51 00 00    	push   0x51a4
    2f81:	e8 1a 07 00 00       	call   36a0 <printf>
}
    ...
    2f98:	68 44 48 00 00       	push   $0x4844
    2f9d:	ff 35 a4 51 00 00    	push   0x51a4
    2fa3:	e8 f8 06 00 00       	call   36a0 <printf>
      exit();
...
00002fb0 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    2fb6:	68 6a 48 00 00       	push   $0x486a
    2fbb:	ff 35 a4 51 00 00    	push   0x51a4
    2fc1:	e8 da 06 00 00       	call   36a0 <printf>
  ...
  printf(stdout, "bss test ok\n");
    ...
    2fe0:	68 85 48 00 00       	push   $0x4885
    2fe5:	ff 35 a4 51 00 00    	push   0x51a4
    2feb:	e8 b0 06 00 00       	call   36a0 <printf>
}
    ...
    2ff8:	68 74 48 00 00       	push   $0x4874
    2ffd:	ff 35 a4 51 00 00    	push   0x51a4
    3003:	e8 98 06 00 00       	call   36a0 <printf>
      exit();
...
00003010 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    3016:	68 92 48 00 00       	push   $0x4892
  ...
  fd = open("bigarg-ok", 0);
    ...
    303a:	6a 00                	push   $0x0
    303c:	68 92 48 00 00       	push   $0x4892
  ...
  unlink("bigarg-ok");
    305a:	c7 04 24 92 48 00 00 	movl   $0x4892,(%esp)
    ...
    306c:	c7 04 85 e0 98 00 00 	movl   $0x4fec,0x98e0(,%eax,4)
    3073:	ec 4f 00 00 
    ...
    3087:	51                   	push   %ecx
    3088:	51                   	push   %ecx
    3089:	68 9c 48 00 00       	push   $0x489c
    308e:	ff 35 a4 51 00 00    	push   0x51a4
    3094:	e8 07 06 00 00       	call   36a0 <printf>
    exec("echo", args);
    3099:	58                   	pop    %eax
    309a:	5a                   	pop    %edx
    309b:	68 e0 98 00 00       	push   $0x98e0
    30a0:	68 69 3a 00 00       	push   $0x3a69
    30a5:	e8 fd 04 00 00       	call   35a7 <exec>
    printf(stdout, "bigarg test ok\n");
    30aa:	59                   	pop    %ecx
    30ab:	58                   	pop    %eax
    30ac:	68 a9 48 00 00       	push   $0x48a9
    30b1:	ff 35 a4 51 00 00    	push   0x51a4
    30b7:	e8 e4 05 00 00       	call   36a0 <printf>
    fd = open("bigarg-ok", O_CREATE);
    30bc:	58                   	pop    %eax
    30bd:	5a                   	pop    %edx
    30be:	68 00 02 00 00       	push   $0x200
    30c3:	68 92 48 00 00       	push   $0x4892
    ...
    30da:	50                   	push   %eax
    30db:	50                   	push   %eax
    30dc:	68 d2 48 00 00       	push   $0x48d2
    30e1:	ff 35 a4 51 00 00    	push   0x51a4
    30e7:	e8 b4 05 00 00       	call   36a0 <printf>
    exit();
    30ec:	e8 7e 04 00 00       	call   356f <exit>
    printf(stdout, "bigargtest: fork failed\n");
    30f1:	52                   	push   %edx
    30f2:	52                   	push   %edx
    30f3:	68 b9 48 00 00       	push   $0x48b9
    30f8:	ff 35 a4 51 00 00    	push   0x51a4
    30fe:	e8 9d 05 00 00       	call   36a0 <printf>
    exit();
...
00003108 <fsfull>:
{
  ...
  printf(1, "fsfull test\n");
    3111:	68 e7 48 00 00       	push   $0x48e7
    3116:	6a 01                	push   $0x1
    3118:	e8 83 05 00 00       	call   36a0 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3188:	50                   	push   %eax
    3189:	68 f4 48 00 00       	push   $0x48f4
    318e:	6a 01                	push   $0x1
    3190:	e8 0b 05 00 00       	call   36a0 <printf>
    ...
    31d1:	50                   	push   %eax
    31d2:	53                   	push   %ebx
    31d3:	68 10 49 00 00       	push   $0x4910
    31d8:	6a 01                	push   $0x1
    31da:	e8 c1 04 00 00       	call   36a0 <printf>
    close(fd);
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    31f8:	50                   	push   %eax
    31f9:	68 00 49 00 00       	push   $0x4900
    31fe:	6a 01                	push   $0x1
    3200:	e8 9b 04 00 00       	call   36a0 <printf>
      break;
  ...
  printf(1, "fsfull test finished\n");
    ...
    3284:	68 20 49 00 00       	push   $0x4920
    3289:	6a 01                	push   $0x1
    328b:	e8 10 04 00 00       	call   36a0 <printf>
}
...
0000329c <uio>:
{
  ...
  printf(1, "uio test\n");
    32a2:	68 36 49 00 00       	push   $0x4936
    32a7:	6a 01                	push   $0x1
    32a9:	e8 f2 03 00 00       	call   36a0 <printf>
  pid = fork();
  ...
  printf(1, "uio test done\n");
    ...
    32c4:	68 40 49 00 00       	push   $0x4940
    32c9:	6a 01                	push   $0x1
    32cb:	e8 d0 03 00 00       	call   36a0 <printf>
}
    ...
    32e3:	52                   	push   %edx
    32e4:	52                   	push   %edx
    32e5:	68 cc 50 00 00       	push   $0x50cc
    32ea:	6a 01                	push   $0x1
    32ec:	e8 af 03 00 00       	call   36a0 <printf>
    exit();
    32f1:	e8 79 02 00 00       	call   356f <exit>
    printf (1, "fork failed\n");
    32f6:	50                   	push   %eax
    32f7:	50                   	push   %eax
    32f8:	68 c5 48 00 00       	push   $0x48c5
    32fd:	6a 01                	push   $0x1
    32ff:	e8 9c 03 00 00       	call   36a0 <printf>
    exit();
...
0000330c <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    3313:	6a 00                	push   $0x0
    3315:	68 4f 49 00 00       	push   $0x494f
  ...
  printf(1, "arg test passed\n");
    3347:	58                   	pop    %eax
    3348:	5a                   	pop    %edx
    3349:	68 61 49 00 00       	push   $0x4961
    334e:	6a 01                	push   $0x1
    3350:	e8 4b 03 00 00       	call   36a0 <printf>
}
    ...
    335d:	51                   	push   %ecx
    335e:	51                   	push   %ecx
    335f:	68 54 49 00 00       	push   $0x4954
    3364:	6a 02                	push   $0x2
    3366:	e8 35 03 00 00       	call   36a0 <printf>
    exit();
    336b:	e8 ff 01 00 00       	call   356f <exit>

00003370 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3370:	a1 a0 51 00 00       	mov    0x51a0,%eax
    ...
    3392:	a3 a0 51 00 00       	mov    %eax,0x51a0
}
    3397:	c3                   	ret    
...
0000360f <getprocs>:
SYSCALL(getprocs)
    360f:	b8 16 00 00 00       	mov    $0x16,%eax
    3614:	cd 40                	int    $0x40
    3616:	c3                   	ret    
    3617:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    361c:	56                   	push   %esi
    361d:	53                   	push   %ebx
    361e:	83 ec 3c             	sub    $0x3c,%esp
    3621:	89 45 bc             	mov    %eax,-0x44(%ebp)
    3624:	89 4d c4             	mov    %ecx,-0x3c(%ebp)
  uint x;
  ...
  if(sgn && xx < 0){
    3629:	8b 5d 08             	mov    0x8(%ebp),%ebx
    362c:	85 db                	test   %ebx,%ebx
    362e:	74 04                	je     3634 <printint+0x1c>
    3630:	85 d2                	test   %edx,%edx
    3632:	78 68                	js     369c <printint+0x84>
  neg = 0;
    3634:	c7 45 08 00 00 00 00 	movl   $0x0,0x8(%ebp)
  } else {
    x = xx;
  }

  i = 0;
    363b:	31 ff                	xor    %edi,%edi
    363d:	8d 75 d7             	lea    -0x29(%ebp),%esi
  do{
    buf[i++] = digits[x % base];
    3640:	89 c8                	mov    %ecx,%eax
    3642:	31 d2                	xor    %edx,%edx
    3644:	f7 75 c4             	divl   -0x3c(%ebp)
    3647:	89 fb                	mov    %edi,%ebx
    3649:	8d 7f 01             	lea    0x1(%edi),%edi
    364c:	8a 92 8c 51 00 00    	mov    0x518c(%edx),%dl
    3652:	88 54 1e 01          	mov    %dl,0x1(%esi,%ebx,1)
  }while((x /= base) != 0);
    3656:	89 4d c0             	mov    %ecx,-0x40(%ebp)
    3659:	89 c1                	mov    %eax,%ecx
    365b:	8b 45 c4             	mov    -0x3c(%ebp),%eax
    365e:	3b 45 c0             	cmp    -0x40(%ebp),%eax
    3661:	76 dd                	jbe    3640 <printint+0x28>
  if(neg)
    3663:	8b 4d 08             	mov    0x8(%ebp),%ecx
    3666:	85 c9                	test   %ecx,%ecx
    3668:	74 09                	je     3673 <printint+0x5b>
    buf[i++] = '-';
    366a:	c6 44 3d d8 2d       	movb   $0x2d,-0x28(%ebp,%edi,1)
    buf[i++] = digits[x % base];
    366f:	89 fb                	mov    %edi,%ebx
    buf[i++] = '-';
    3671:	b2 2d                	mov    $0x2d,%dl

  while(--i >= 0)
    3673:	8d 5c 1d d7          	lea    -0x29(%ebp,%ebx,1),%ebx
    3677:	8b 7d bc             	mov    -0x44(%ebp),%edi
    367a:	eb 03                	jmp    367f <printint+0x67>
    putc(fd, buf[i]);
    367c:	8a 13                	mov    (%ebx),%dl
    367e:	4b                   	dec    %ebx
    367f:	88 55 d7             	mov    %dl,-0x29(%ebp)
  write(fd, &c, 1);
    3682:	50                   	push   %eax
    3683:	6a 01                	push   $0x1
    3685:	56                   	push   %esi
    3686:	57                   	push   %edi
    3687:	e8 03 ff ff ff       	call   358f <write>
  while(--i >= 0)
    368c:	83 c4 10             	add    $0x10,%esp
    368f:	39 de                	cmp    %ebx,%esi
    3691:	75 e9                	jne    367c <printint+0x64>
}
    3693:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3696:	5b                   	pop    %ebx
    3697:	5e                   	pop    %esi
    3698:	5f                   	pop    %edi
    3699:	5d                   	pop    %ebp
    ...
    x = -xx;
    369c:	f7 d9                	neg    %ecx
    369e:	eb 9b                	jmp    363b <printint+0x23>
...
printf(int fd, const char *fmt, ...)
{
    ...
    36a4:	56                   	push   %esi
    36a5:	53                   	push   %ebx
    36a6:	83 ec 2c             	sub    $0x2c,%esp
    36a9:	8b 75 08             	mov    0x8(%ebp),%esi
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    36ac:	8b 5d 0c             	mov    0xc(%ebp),%ebx
    36af:	8a 13                	mov    (%ebx),%dl
    36b1:	84 d2                	test   %dl,%dl
    36b3:	74 64                	je     3719 <printf+0x79>
    36b5:	43                   	inc    %ebx
  ap = (uint*)(void*)&fmt + 1;
    36b6:	8d 45 10             	lea    0x10(%ebp),%eax
    36b9:	89 45 d0             	mov    %eax,-0x30(%ebp)
  state = 0;
    36bc:	31 c9                	xor    %ecx,%ecx
  write(fd, &c, 1);
    36be:	8d 7d e7             	lea    -0x19(%ebp),%edi
    36c1:	eb 24                	jmp    36e7 <printf+0x47>
    36c3:	90                   	nop
    36c4:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
    36c7:	83 f8 25             	cmp    $0x25,%eax
    36ca:	74 40                	je     370c <printf+0x6c>
        state = '%';
      } else {
        putc(fd, c);
    36cc:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
    36cf:	50                   	push   %eax
    36d0:	6a 01                	push   $0x1
    36d2:	57                   	push   %edi
    36d3:	56                   	push   %esi
    36d4:	e8 b6 fe ff ff       	call   358f <write>
        putc(fd, c);
    36d9:	83 c4 10             	add    $0x10,%esp
    36dc:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
  for(i = 0; fmt[i]; i++){
    36df:	43                   	inc    %ebx
    36e0:	8a 53 ff             	mov    -0x1(%ebx),%dl
    36e3:	84 d2                	test   %dl,%dl
    36e5:	74 32                	je     3719 <printf+0x79>
    c = fmt[i] & 0xff;
    36e7:	0f b6 c2             	movzbl %dl,%eax
    if(state == 0){
    36ea:	85 c9                	test   %ecx,%ecx
    36ec:	74 d6                	je     36c4 <printf+0x24>
      }
    } else if(state == '%'){
    36ee:	83 f9 25             	cmp    $0x25,%ecx
    36f1:	75 ec                	jne    36df <printf+0x3f>
      if(c == 'd'){
    36f3:	83 f8 25             	cmp    $0x25,%eax
    36f6:	0f 84 e4 00 00 00    	je     37e0 <printf+0x140>
    36fc:	83 e8 63             	sub    $0x63,%eax
    36ff:	83 f8 15             	cmp    $0x15,%eax
    3702:	77 20                	ja     3724 <printf+0x84>
    3704:	ff 24 85 34 51 00 00 	jmp    *0x5134(,%eax,4)
    370b:	90                   	nop
        state = '%';
    370c:	b9 25 00 00 00       	mov    $0x25,%ecx
  for(i = 0; fmt[i]; i++){
    3711:	43                   	inc    %ebx
    3712:	8a 53 ff             	mov    -0x1(%ebx),%dl
    3715:	84 d2                	test   %dl,%dl
    3717:	75 ce                	jne    36e7 <printf+0x47>
        putc(fd, c);
      }
      state = 0;
    }
    ...
    3719:	8d 65 f4             	lea    -0xc(%ebp),%esp
    371c:	5b                   	pop    %ebx
    371d:	5e                   	pop    %esi
    371e:	5f                   	pop    %edi
    371f:	5d                   	pop    %ebp
    3720:	c3                   	ret    
    3721:	8d 76 00             	lea    0x0(%esi),%esi
    3724:	88 55 d4             	mov    %dl,-0x2c(%ebp)
        putc(fd, '%');
    3727:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
  write(fd, &c, 1);
    372b:	50                   	push   %eax
    372c:	6a 01                	push   $0x1
    372e:	57                   	push   %edi
    372f:	56                   	push   %esi
    3730:	e8 5a fe ff ff       	call   358f <write>
        putc(fd, c);
    3735:	8a 55 d4             	mov    -0x2c(%ebp),%dl
    3738:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
    373b:	83 c4 0c             	add    $0xc,%esp
    373e:	6a 01                	push   $0x1
    3740:	57                   	push   %edi
    3741:	56                   	push   %esi
    3742:	e8 48 fe ff ff       	call   358f <write>
        putc(fd, c);
    3747:	83 c4 10             	add    $0x10,%esp
      state = 0;
    374a:	31 c9                	xor    %ecx,%ecx
    374c:	eb 91                	jmp    36df <printf+0x3f>
    374e:	66 90                	xchg   %ax,%ax
        printint(fd, *ap, 16, 0);
    3750:	83 ec 0c             	sub    $0xc,%esp
    3753:	6a 00                	push   $0x0
    3755:	b9 10 00 00 00       	mov    $0x10,%ecx
    375a:	8b 45 d0             	mov    -0x30(%ebp),%eax
    375d:	8b 10                	mov    (%eax),%edx
    375f:	89 f0                	mov    %esi,%eax
    3761:	e8 b2 fe ff ff       	call   3618 <printint>
        ap++;
    3766:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    376a:	83 c4 10             	add    $0x10,%esp
      state = 0;
    376d:	31 c9                	xor    %ecx,%ecx
        ap++;
    376f:	e9 6b ff ff ff       	jmp    36df <printf+0x3f>
        s = (char*)*ap;
    3774:	8b 45 d0             	mov    -0x30(%ebp),%eax
    3777:	8b 10                	mov    (%eax),%edx
        ap++;
    3779:	83 c0 04             	add    $0x4,%eax
    377c:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    377f:	85 d2                	test   %edx,%edx
    3781:	74 69                	je     37ec <printf+0x14c>
        while(*s != 0){
    3783:	8a 02                	mov    (%edx),%al
    3785:	84 c0                	test   %al,%al
    3787:	74 71                	je     37fa <printf+0x15a>
    3789:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    378c:	89 d3                	mov    %edx,%ebx
    378e:	66 90                	xchg   %ax,%ax
          putc(fd, *s);
    3790:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    3793:	50                   	push   %eax
    3794:	6a 01                	push   $0x1
    3796:	57                   	push   %edi
    3797:	56                   	push   %esi
    3798:	e8 f2 fd ff ff       	call   358f <write>
          s++;
    379d:	43                   	inc    %ebx
        while(*s != 0){
    379e:	8a 03                	mov    (%ebx),%al
    37a0:	83 c4 10             	add    $0x10,%esp
    37a3:	84 c0                	test   %al,%al
    37a5:	75 e9                	jne    3790 <printf+0xf0>
      state = 0;
    37a7:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
    37aa:	31 c9                	xor    %ecx,%ecx
    37ac:	e9 2e ff ff ff       	jmp    36df <printf+0x3f>
    37b1:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 10, 1);
    37b4:	83 ec 0c             	sub    $0xc,%esp
    37b7:	6a 01                	push   $0x1
    37b9:	b9 0a 00 00 00       	mov    $0xa,%ecx
    37be:	eb 9a                	jmp    375a <printf+0xba>
        putc(fd, *ap);
    37c0:	8b 45 d0             	mov    -0x30(%ebp),%eax
    37c3:	8b 00                	mov    (%eax),%eax
    37c5:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    37c8:	51                   	push   %ecx
    37c9:	6a 01                	push   $0x1
    37cb:	57                   	push   %edi
    37cc:	56                   	push   %esi
    37cd:	e8 bd fd ff ff       	call   358f <write>
        ap++;
    37d2:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    37d6:	83 c4 10             	add    $0x10,%esp
      state = 0;
    37d9:	31 c9                	xor    %ecx,%ecx
    37db:	e9 ff fe ff ff       	jmp    36df <printf+0x3f>
        putc(fd, c);
    37e0:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
    37e3:	52                   	push   %edx
    37e4:	e9 55 ff ff ff       	jmp    373e <printf+0x9e>
    37e9:	8d 76 00             	lea    0x0(%esi),%esi
          s = "(null)";
    37ec:	ba 2c 51 00 00       	mov    $0x512c,%edx
        while(*s != 0){
    37f1:	b0 28                	mov    $0x28,%al
    37f3:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    37f6:	89 d3                	mov    %edx,%ebx
    37f8:	eb 96                	jmp    3790 <printf+0xf0>
      state = 0;
    37fa:	31 c9                	xor    %ecx,%ecx
    37fc:	e9 de fe ff ff       	jmp    36df <printf+0x3f>
    3801:	66 90                	xchg   %ax,%ax
    3803:	90                   	nop
...
free(void *ap)
{
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    3841:	89 15 60 99 00 00    	mov    %edx,0x9960
}
    3847:	5b                   	pop    %ebx
    3848:	5e                   	pop    %esi
    3849:	5f                   	pop    %edi
    ...
    384b:	c3                   	ret    
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    384c:	39 c2                	cmp    %eax,%edx
    384e:	72 c8                	jb     3818 <free+0x14>
    3850:	39 c1                	cmp    %eax,%ecx
    3852:	73 c4                	jae    3818 <free+0x14>
  if(bp + bp->s.size == p->s.ptr){
    3854:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3857:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    385a:	39 f8                	cmp    %edi,%eax
    385c:	75 d4                	jne    3832 <free+0x2e>
    bp->s.size += p->s.ptr->s.size;
    385e:	03 70 04             	add    0x4(%eax),%esi
    3861:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    3864:	8b 02                	mov    (%edx),%eax
    3866:	8b 00                	mov    (%eax),%eax
    3868:	89 43 f8             	mov    %eax,-0x8(%ebx)
  if(p + p->s.size == bp){
    386b:	8b 42 04             	mov    0x4(%edx),%eax
    386e:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    3871:	39 f1                	cmp    %esi,%ecx
    3873:	75 ca                	jne    383f <free+0x3b>
    p->s.size += bp->s.size;
    3875:	03 43 fc             	add    -0x4(%ebx),%eax
    3878:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    387b:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    387e:	89 0a                	mov    %ecx,(%edx)
  freep = p;
    3880:	89 15 60 99 00 00    	mov    %edx,0x9960
}
    3886:	5b                   	pop    %ebx
    3887:	5e                   	pop    %esi
    3888:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    3898:	8d 70 07             	lea    0x7(%eax),%esi
    389b:	c1 ee 03             	shr    $0x3,%esi
    389e:	46                   	inc    %esi
  if((prevp = freep) == 0){
    389f:	8b 3d 60 99 00 00    	mov    0x9960,%edi
    38a5:	85 ff                	test   %edi,%edi
    38a7:	0f 84 a3 00 00 00    	je     3950 <malloc+0xc4>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    38ad:	8b 17                	mov    (%edi),%edx
    if(p->s.size >= nunits){
    38af:	8b 4a 04             	mov    0x4(%edx),%ecx
    38b2:	39 f1                	cmp    %esi,%ecx
    38b4:	73 68                	jae    391e <malloc+0x92>
    38b6:	89 f3                	mov    %esi,%ebx
    38b8:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
    38be:	0f 82 80 00 00 00    	jb     3944 <malloc+0xb8>
  p = sbrk(nu * sizeof(Header));
    38c4:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    38cb:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    38ce:	eb 11                	jmp    38e1 <malloc+0x55>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    38d0:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    38d2:	8b 48 04             	mov    0x4(%eax),%ecx
    38d5:	39 f1                	cmp    %esi,%ecx
    38d7:	73 4b                	jae    3924 <malloc+0x98>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    38d9:	8b 3d 60 99 00 00    	mov    0x9960,%edi
    38df:	89 c2                	mov    %eax,%edx
    38e1:	39 d7                	cmp    %edx,%edi
    38e3:	75 eb                	jne    38d0 <malloc+0x44>
  p = sbrk(nu * sizeof(Header));
    38e5:	83 ec 0c             	sub    $0xc,%esp
    38e8:	ff 75 e4             	push   -0x1c(%ebp)
    38eb:	e8 07 fd ff ff       	call   35f7 <sbrk>
  if(p == (char*)-1)
    38f0:	83 c4 10             	add    $0x10,%esp
    38f3:	83 f8 ff             	cmp    $0xffffffff,%eax
    38f6:	74 1c                	je     3914 <malloc+0x88>
  hp->s.size = nu;
    38f8:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    38fb:	83 ec 0c             	sub    $0xc,%esp
    38fe:	83 c0 08             	add    $0x8,%eax
    3901:	50                   	push   %eax
    3902:	e8 fd fe ff ff       	call   3804 <free>
  return freep;
    3907:	8b 15 60 99 00 00    	mov    0x9960,%edx
      if((p = morecore(nunits)) == 0)
    390d:	83 c4 10             	add    $0x10,%esp
    3910:	85 d2                	test   %edx,%edx
    3912:	75 bc                	jne    38d0 <malloc+0x44>
        return 0;
    3914:	31 c0                	xor    %eax,%eax
  }
}
    3916:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3919:	5b                   	pop    %ebx
    391a:	5e                   	pop    %esi
    391b:	5f                   	pop    %edi
    391c:	5d                   	pop    %ebp
    ...
    3920:	89 fa                	mov    %edi,%edx
    3922:	66 90                	xchg   %ax,%ax
      if(p->s.size == nunits)
    3924:	39 ce                	cmp    %ecx,%esi
    3926:	74 54                	je     397c <malloc+0xf0>
        p->s.size -= nunits;
    3928:	29 f1                	sub    %esi,%ecx
    392a:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    392d:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    3930:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    3933:	89 15 60 99 00 00    	mov    %edx,0x9960
      return (void*)(p + 1);
    3939:	83 c0 08             	add    $0x8,%eax
}
    ...
    3942:	5d                   	pop    %ebp
    3943:	c3                   	ret    
    3944:	bb 00 10 00 00       	mov    $0x1000,%ebx
    3949:	e9 76 ff ff ff       	jmp    38c4 <malloc+0x38>
    394e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
    3950:	c7 05 60 99 00 00 64 	movl   $0x9964,0x9960
    3957:	99 00 00 
    395a:	c7 05 64 99 00 00 64 	movl   $0x9964,0x9964
    3961:	99 00 00 
    base.s.size = 0;
    3964:	c7 05 68 99 00 00 00 	movl   $0x0,0x9968
    396b:	00 00 00 
    396e:	bf 64 99 00 00       	mov    $0x9964,%edi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3973:	89 fa                	mov    %edi,%edx
    3975:	e9 3c ff ff ff       	jmp    38b6 <malloc+0x2a>
    397a:	66 90                	xchg   %ax,%ax
        prevp->s.ptr = p->s.ptr;
    397c:	8b 08                	mov    (%eax),%ecx
    397e:	89 0a                	mov    %ecx,(%edx)
    3980:	eb b1                	jmp    3933 <malloc+0xa7>
